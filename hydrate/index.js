...
const NAMESPACE = 'kompas-web-components';
const BUILD = /* kompas-web-components */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: false, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: true, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: false, devTools: false, disconnectedCallback: false, dynamicImportShim: false, element: false, event: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: true, propMutable: false, propNumber: true, propString: true, reflect: false, safari10: false, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: false, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: true, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: true, vdomListener: true, vdomPropOrAttr: true, vdomRef: true, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: false, watchCallback: true };
...
const createElm = (e, t, o, n) => {
 ...
 let l;
 return t ? ((l = safeCall(s, "componentWillLoad"))) : (BUILD.cmpWillUpdate ), (l = then(l, (() => safeCall(s, "componentWillRender")))), 
...
const kidMeteredPaywallCss = ".text-transition.sc-kid-metered-paywall{height:5rem;width:100%}.body.sc-kid-metered-paywall{height:100%;position:-webkit-sticky;position:sticky;top:0;width:100%}.icon.sc-kid-metered-paywall{--tw-text-opacity:1;color:rgba(106,195,34,var(--tw-text-opacity));height:1rem}.icon.lg.sc-kid-metered-paywall,.icon.lg.sc-kid-metered-paywall svg.sc-kid-metered-paywall{height:1.5rem}";

class KidMeteredPaywall {
    constructor(hostRef) {
    ...
    getCountdownArticle() {
        ...
        if (getCountdown > 0 && getCountdown < 5) {
            return hAsync("p", null, "Anda memiliki sisa ", hAsync("b", null, this.countdownArticle, " dari 5"), " artikel premium gratis bulan ini. Langganan untuk akses tanpa batas");
        }
        else {
            return hAsync("p", null, "Anda sedang membaca ", hAsync("b", null, "artikel gratis terakhir bulan ini."), " Langganan untuk akses tanpa batas");
        }
    }
    templateMeteredPaywall() {
        return (hAsync("div", { class: "flex flex-row w-full bg-blue-100 py-4 justify-center space-x-4 px-4 lg:px-0 bottom-0" }, hAsync("div", { class: "text-grey-600 text-sm md:text-lg self-center text-left" }, this.getCountdownArticle()), hAsync("div", { class: "self-center" }, hAsync("a", { href: "https://www.kompas.id/berlangganan", class: "bg-green-400 p-2 rounded-md font-bold text-grey-100 text-sm md:text-xl" }, "Langganan"))));
    }
    render() {
        return (hAsync("div", { class: "sticky bottom-0 w-full h-full" }, this.countdownArticle > 0 && this.countdownArticle < 6 ? this.templateMeteredPaywall() : ""));
    }
    static get style() { return kidMeteredPaywallCss; }
    static get cmpMeta() {
        return {
            "$flags$": 9,
            "$tagName$": "kid-metered-paywall",
            "$members$": {
                "countdownArticle": [2, "countdown-article"]
            },
            "$listeners$": undefined,
            "$lazyBundleId$": "-",
            "$attrsToReflect$": []
...
var check = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M173.898 439.404l-166.4-166.4c-9.997-9.997-9.997-26.206 0-36.204l36.203-36.204c9.997-9.998 26.207-9.998 36.204 0L192 312.69 432.095 72.596c9.997-9.997 26.207-9.997 36.204 0l36.203 36.204c9.997 9.997 9.997 26.206 0 36.204l-294.4 294.401c-9.998 9.997-26.207 9.997-36.204-.001z"/></svg>`;

const kidPaywallCss = ".transparent-linear.sc-kid-paywall{background-image:linear-gradient(180deg,hsla(0,0%,100%,0),#fff)}.text-transition.sc-kid-paywall{height:5rem;width:100%}.icon.sc-kid-paywall{--tw-text-opacity:1;color:rgba(106,195,34,var(--tw-text-opacity));height:1rem}.icon.sc-kid-paywall svg.sc-kid-paywall{fill:currentColor;display:block;height:1rem}.icon.lg.sc-kid-paywall,.icon.lg.sc-kid-paywall svg.sc-kid-paywall{height:1.5rem}";
...
class KidPaywall {
    constructor(hostRef) {
         ...
         */
        this.excerpt = "Dapatkan akses tanpa batas ke seluruh artikel premium dengan berlangganan Kompas.id.";
        /**
         * Judul paywal
         */
        this.title = "Jadilah Bagian dari Jurnalisme Berkualitas 2";
    }
    /**
     * TEMPLATING
     */
     ...
     */
    templateError() {
        return (hAsync("div", { class: "bg-red-200 p-4 rounded w-full" }, hAsync("h3", { class: "font-bold mb-2 mt-0 mx-0 text-base leading-tight" }, "Galat"), hAsync("p", { class: "my-0 text-base" }, this.errorMsg)));
    }
    /**
     * Mengelola tampilan paywall secara general
     */
    templateResult() {
        return (hAsync("div", null, hAsync("div", { class: "transparent-linear text-transition" }), this.showRegistration ? this.templateBannerRegistration() : "", this.showRegistration ? this.templateHeader() : "", this.showMembership ? this.templateTitle() : "", this.showMembership ? this.templateMemberships() : ""));
    }
    /**
     * Mengelola tampilan pada section Header
     */
    templateHeader() {
        return (hAsync("div", { class: "bg-grey-100 py-6 flex flex-col font-sans items-center w-full lg:flex-row lg:justify-between" }, hAsync("div", null, this.login.text, hAsync("a", { class: "font-bold text-brand-1 underline", href: this.gtmPermalink(this.addNextParam(this.login.url), this.gtmLoginMedium) }, this.login.label)), hAsync("a", { class: "font-bold text-brand-1 underline", href: this.gtmPermalink(this.branding.url, this.gtmBrandingMedium), target: "_blank" }, this.branding.label)));
    }
    /**
     * mengelola tampilan pada section judul
     */
    templateTitle() {
        return (hAsync("div", { class: "bg-grey-100 flex flex-col items-center text-center pb-8 w-full" }, hAsync("span", { class: "flex font-serif font-bold text-4xl pb-2" }, this.title), hAsync("span", { class: "flex text-base" }, this.excerpt)));
    }
    /**
    ...
    templateMemberships() {
        const membership = () => {
            const benefitsList = (benefits, popular) => {
                return benefits.map((list) => {
                    return (hAsync("div", { class: "flex py-1 w-full" }, hAsync("span", { class: "pr-2 icon", innerHTML: check }), hAsync("div", { class: `text-left text-sm ${popular ? "text-grey-100" : "text-grey-700"}` }, list)));
                });
            };
            const labelPopular = hAsync("div", { class: "bg-orange-300 p-1 text-center mx-4" }, "POPULER");
            const items = this.items.map((item, index) => {
                return (hAsync("div", { class: `flex flex-col px-4 w-full box-border lg:order-none ${item.popular ? "order-first" : ""}` }, hAsync("div", { class: item.popular ? "px-4" : "p-4" }, item.popular ? labelPopular : ""), hAsync("div", { class: `${item.popular ? "bg-brand-1 text-grey-100" : "border border-grey-300"} shadow-md flex flex-grow flex-col rounded-lg w-full mb-4` }, hAsync("div", { class: "font-bold text-center text-2xl px-4 py-8" }, item.title), hAsync("img", { src: item.image, alt: item.title, class: "w-full mb-6" }), hAsync("div", { class: "text-center" }, hAsync("span", { class: "font-bold text-lg" }, this.rupiahFormat(item.harga)), hAsync("span", { class: "lowercase" }, " /", item.satuan)), hAsync("div", { class: "px-4 text-sm" }, hAsync("a", { href: this.gtmPermalink(item.url, `${this.gtmPaywallMedium}${index}`), class: "font-bold bg-green-400 capitalize text-grey-100 rounded-lg h-10 px-5 text-xl leading-7 flex justify-center items-center", target: "_blank" }, "BERLANGGANAN"), hAsync("div", { class: "flex flex-col p-2 w-full" }, benefitsList(item.benefits, item.popular))))));
            });
            return (hAsync("div", { class: "bg-grey-100 font-sans w-full flex flex-col pb-8 lg:flex-row" }, items));
        };
        return membership();
    }
    /**
     ...
     */
    templateBannerRegistration() {
        if (!this.isLogin) {
            return (hAsync("div", { class: "box-border flex flex-col w-full items-center p-4 bg-blue-100  md:flex-row  md:py-0  md:px-8" }, hAsync("div", { class: "flex w-full pb-3 md:pb-0 md:w-3/4" }, hAsync("div", { class: "flex-1" }, hAsync("img", { src: this.registration.content.img, alt: "banner registration" })), hAsync("div", { class: "flex w-3/4 items-center justify-center" }, hAsync("div", { class: "font-sans text-grey-600 text-base font-bold pl-4 md:text-xl md:text-center" }, this.registration.content.text))), hAsync("div", { class: "w-full justify-end md:w-1/4 md:flex" }, hAsync("a", { href: this.gtmPermalink(this.addNextParam(this.registration.action.url), this.gtmLoginMedium), class: "w-full font-bold shadow capitalize rounded px-4 h-8 leading-8 justify-center items-center inline-flex bg-green-400 text-grey-100 md:w-auto select-none" }, hAsync("span", { class: "inline" }, this.registration.action.label)))));
        }
        else {
    ...
    async componentWillLoad() {
        try {
            ...
            const { result: { title = this.title, excerpt = this.excerpt, memberships, login = this.login, branding = this.branding, registration = this.registration } } = reqJson;
    ...
    render() {
        return (hAsync("div", { class: `relative w-full mb-4 ${this.errorMsg ? "" : "-mt-24"}` }, this.errorMsg ? this.templateError() : this.templateResult()));
    }
    static get style() { return kidPaywallCss; }
    static get cmpMeta() {
        return {
            "$flags$": 9,
            "$tagName$": "kid-paywall",
            "$members$": {
                "isLogin": [4, "is-login"],
                "showRegistration": [4, "show-registration"],
                "showMembership": [4, "show-membership"],
                "gtmTrackSource": [1, "gtm-track-source"],
                "gtmTrackContent": [1, "gtm-track-content"],
                "gtmLoginMedium": [1, "gtm-login-medium"],
                "gtmBrandingMedium": [1, "gtm-branding-medium"],
                "gtmPaywallMedium": [1, "gtm-paywall-medium"],
                "errorMsg": [32],
                "excerpt": [32],
                "title": [32],
                "items": [32],
...
const kidRecommenderCss = ".sc-kid-recommender-h{display:block}.sc-kid-recommender-h .sc-kid-recommender{box-sizing:border-box}.container.sc-kid-recommender{display:flex;height:138px;width:100%}.result.sc-kid-recommender{--tw-border-opacity:1;border-color:rgba(153,153,153,var(--tw-border-opacity));border-radius:.25rem;border-style:solid;border-width:1px;flex:1 1 0%;height:100%;overflow:hidden}.result--inner.sc-kid-recommender{border-left:4px solid #fc0;display:block;display:flow-root;height:100%;padding:1rem;text-decoration:none;width:100%}.result--inner__headline-label.sc-kid-recommender{--tw-text-opacity:1;color:rgba(4,104,203,var(--tw-text-opacity));display:inline;font-size:.875rem;line-height:1.25rem;margin-bottom:.5rem}.result--inner__headline-label.dark.sc-kid-recommender{--tw-text-opacity:1;color:rgba(147,200,253,var(--tw-text-opacity))}.result--inner__headline-title.sc-kid-recommender{--tw-text-opacity:1;color:rgba(51,51,51,var(--tw-text-opacity));display:inline;font-size:1rem;font-weight:700;line-height:1.5rem;line-height:1.25;margin:0}.result--inner__headline-title.dark.sc-kid-recommender{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.result--inner__thumbnail.sc-kid-recommender{--tw-border-opacity:1;background-position:50%;background-repeat:no-repeat;background-size:cover;border-color:rgba(238,238,238,var(--tw-border-opacity));border-radius:.25rem;border-style:solid;border-width:1px;display:inline;float:right;height:64px;margin-left:1rem;width:96px}.error.sc-kid-recommender{--tw-bg-opacity:1;background-color:rgba(253,189,160,var(--tw-bg-opacity));border-radius:.25rem;padding:1rem;width:100%}.error--label.sc-kid-recommender{font-size:1rem;font-weight:700;line-height:1.5rem;line-height:1.25;margin:0 0 .5rem}.error--text.sc-kid-recommender{font-size:1rem;line-height:1.5rem;margin-bottom:0;margin-top:0}@media (min-width:768px){.container.sc-kid-recommender{height:126px}.result--inner__thumbnail.sc-kid-recommender{height:96px;width:144px}}";

class KidRecommender {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        /**
         ...
         */
        this.position = "rekomendasi_inbody";
        /**
         ...
         */
        this.resLabel = "Artikel Kompas.id";
        /**
         * Pesan apabila terjadi galat, berubah ketika terjadi galat
         */
        this.errorMsg = "";
    ...
    templateError() {
        return (hAsync("div", { class: "error" }, hAsync("h3", { class: "error--label" }, "Galat"), hAsync("p", { class: "error--text" }, this.errorMsg)));
    }
    templateResult() {
        return (hAsync("div", { class: "result" }, hAsync("a", { class: "result--inner", href: this.resPermalink, target: "_blank", title: this.resTitle }, hAsync("div", { class: "result--inner__thumbnail", style: {
                backgroundImage: `url(${this.resThumbnail})`
            } }), hAsync("span", { class: {
                "result--inner__headline-label": true,
                "dark": this.darkMode
            } }, this.resLabel), hAsync("br", null), hAsync("h2", { class: {
    ...
    async componentWillLoad() {
        try {
            ...
            const params = Object
                ...
                .join("&");
            const req = await fetch(`https://apiner.kompas.id/v1/article?${params}`, {
                method: "GET",
                // mode: 'no-cors',
                headers: {
             ...
             */
            const reqJson = await req.json();
            const { judul = "", thumbnail = "", url = "" } = reqJson;
            this.resTitle = judul;
    ...
    render() {
        return (hAsync("div", { class: "container" }, this.errorMsg ? this.templateError() : this.templateResult()));
    }
    static get watchers() {
        return {
    ...
    static get style() { return kidRecommenderCss; }
    static get cmpMeta() {
        return {
            "$flags$": 9,
            "$tagName$": "kid-recommender",
            "$members$": {
                "authKey": [1, "auth-key"],
                "darkMode": [4, "dark-mode"],
                "postTags": [1, "post-tags"],
                "postTitle": [1, "post-title"],
                "postUrl": [1, "post-url"],
                "position": [1],
                "section": [1],
                "errorMsg": [32],
		...
		links: [
			{
				...
				url: "https://korporasi.kompas.id/"
			},
			{
				label: "Sejarah",
				url: "https://korporasi.kompas.id/profil/cerita-berdiri/"
			},
			{
				label: "Organisasi",
				url: "https://kompas.id/organisasi/"
			}
		]
	},
	business_division: {
		address: "Menara Kompas Lantai 2<br />\r\nJalan Palmerah Selatan 21<br />\r\nJakarta Pusat, DKI Jakarta,<br />\r\nIndonesia 10270",
		phones: [
			{
				number: "+6221 8062 6699"
			}
		]
	},
	editorial_division: {
		address: "Gedung Kompas Gramedia<br />\r\nJalan Palmerah Selatan 26-28,<br />\r\nDKI Jakarta, Indonesia<br />\r\n10270",
		phones: [
			{
				number: "+6221 5347 710"
			},
			{
				number: "+6221 5347 720"
			},
			{
				number: "+6221 5347 730"
			},
			{
				number: "+6221 530 2200"
			}
		]
	},
	logo: {
		uri: "https://kompas.id/wp-content/themes/mumed_kompas_dot_id_2016/assets/img/logos/kompas-footer-logo.svg"
	},
	others: {
		links: [
			{
				label: "Bantuan",
				url: "https://kb.kompas.id"
			}
		]
	},
	products: {
		business: {
			...
			items: [
				{
					name: "Advertorial",
					url: "https://adv.kompas.id/"
				},
				{
					name: "Gerai",
					url: "https://gerai.kompas.id/"
				},
				{
					name: "Event",
					url: "https://korporasi.kompas.id/produk/event/"
				},
				{
					name: "Klasika",
					url: "https://klasika.kompas.id/"
				},
				{
					name: "Tarif",
					url: "https://korporasi.kompas.id/produk/iklan/"
				},
				{
					name: "Klasiloka",
					url: "https://klasiloka.kompas.id/"
				}
			]
		},
		editorial: {
			...
			items: [
				...
				{
					name: "Interaktif",
					url: "https://interaktif.kompas.id/"
				},
				{
					name: "Kompas Data",
					url: "http://www.kompasdata.id/"
				}
			]
		}
	},
	profile: {
		text: "Harian Kompas adalah surat kabar Indonesia yang berkantor pusat di Jakarta. Kompas diterbitkan oleh PT Kompas Media Nusantara yang merupakan bagian dari kelompok usaha Kompas Gramedia (KG), yang didirikan oleh P.K. Ojong (almarhum) dan Jakob Oetama sejak 28 Juni 1965.<br />\r\n<br />\r\nMengusung semboyan \"Amanat Hati Nurani Rakyat\", Kompas dikenal sebagai sumber informasi tepercaya, akurat, dan mendalam."
	},
	social_accounts: {
		items: [
			{
				...
				name: "@hariankompas",
				url: "https://facebook.com/hariankompas"
			},
			{
				"class": "fa fa-twitter-square",
				name: "@hariankompas",
				url: "https://twitter.com/hariankompas"
			},
			{
				"class": "fa fa-instagram",
				name: "@hariankompas",
				url: "https://instagram.com/hariankompas"
			},
			{
				"class": "fa fa-youtube-square",
				name: "Harian Kompas",
				url: "https://www.youtube.com/user/hariankompas"
			}
		]
	},
	support: {
...
const menus = {
	footer_left: {
		...
		GPT1BNDL: {
			name: "Hubungi Kami",
			url: "https://kompas.id/hubungi-kami//",
			id: 1760,
			slug: "gpt1bndl"
		},
		"Sidik Gangguan": {
			name: "Sidik Gangguan",
			url: "http://kompas.id/sidik-gangguan//",
			id: 1763,
			slug: null
		},
		"milea:suara dari dilan": {
			name: "Pedoman Media Siber",
			url: "https://kompas.id/pedoman-media-siber//",
			id: 299642,
			slug: "mileasuara-dari-dilan"
		},
		"Syarat & Ketentuan": {
			name: "Syarat & Ketentuan",
			url: "https://kompas.id/syarat-dan-ketentuan//",
			id: 1766,
			slug: null
		}
	},
	...
	sidebar: {
		...
		"Politik &amp; Hukum": {
			name: "Politik &amp; Hukum",
			url: "https://kompas.id/kategori/polhuk/",
			id: 3490378,
			slug: "polhuk",
			sub_rubrik: [
				{
					name: "Pemilu",
					url: "https://kompas.id/kategori/polhuk/pemilu/",
					id: 4477818,
					slug: "pemilu"
				}
			]
		...
		Ekonomi: {
			name: "Ekonomi",
			url: "https://kompas.id/kategori/ekonomi/",
			id: 3490382,
			slug: "ekonomi",
			sub_rubrik: [
				{
					name: "Wirausaha",
					url: "https://kompas.id/kategori/ekonomi/wirausaha/",
					id: 5457033,
					slug: "wirausaha"
				}
			]
		...
		Opini: {
			name: "Opini",
			url: "https://kompas.id/kategori/opini/",
			id: 3490390,
			slug: "opini",
			sub_rubrik: [
				{
					name: "Artikel Opini",
					url: "https://kompas.id/kategori/opini/artikel-opini/",
					id: 4139610,
					slug: "artikel-opini"
				},
				{
					name: "Analisis Ekonomi",
					url: "https://kompas.id/kategori/opini/analisis-ekonomi/",
					id: 4139086,
					slug: "analisis-ekonomi"
				},
				{
					name: "Analisis Politik",
					url: "https://kompas.id/kategori/opini/analisis-politik/",
					id: 4139090,
					slug: "analisis-politik"
				},
				{
					name: "Kolom",
					url: "https://kompas.id/kategori/opini/kolom/",
					id: 4139474,
					slug: "kolom"
				},
				{
					name: "Tajuk Rencana",
					url: "https://kompas.id/kategori/opini/tajuk-rencana/",
					id: 4139322,
					slug: "tajuk-rencana"
				},
				{
					name: "Surat Pembaca",
					url: "https://kompas.id/kategori/opini/surat-pembaca/",
					id: 4139298,
					slug: "surat-pembaca"
				}
			]
		...
		Humaniora: {
			name: "Humaniora",
			url: "https://kompas.id/kategori/humaniora/",
			id: 4139870,
			slug: "humaniora",
			sub_rubrik: [
				{
					name: "Dikbud",
					url: "https://kompas.id/kategori/humaniora/dikbud/",
					id: 3490394,
					slug: "dikbud"
				},
				{
					name: "Iptek",
					url: "https://kompas.id/kategori/humaniora/ilmu-pengetahuan-teknologi/",
					id: 3490402,
					slug: "ilmu-pengetahuan-teknologi"
				},
				{
					name: "Kesehatan",
					url: "https://kompas.id/kategori/humaniora/kesehatan/",
					id: 4140130,
					slug: "kesehatan"
				}
			]
		...
		Riset: {
			name: "Riset",
			url: "https://kompas.id/kategori/riset/",
			id: 3490422,
			slug: "riset",
			sub_rubrik: [
				{
					name: "Survei",
					url: "https://kompas.id/kategori/riset/opini-publik/",
					id: 3490442,
					slug: "opini-publik"
				},
				{
					name: "Linimasa",
					url: "https://kompas.id/kategori/riset/linimasa/",
					id: 4142278,
					slug: "linimasa"
				},
				{
					name: "Kajian Data",
					url: "https://kompas.id/kategori/riset/telaah/",
					id: 3490454,
					slug: "telaah"
				}
			]
		...
		Nusantara: {
			name: "Nusantara",
			url: "https://kompas.id/kategori/nusantara/",
			id: 3490426,
			slug: "nusantara"
		},
		Metropolitan: {
			name: "Metropolitan",
			url: "https://kompas.id/kategori/metro/",
			id: 3490434,
			slug: "metro"
		},
		Internasional: {
			name: "Internasional",
			url: "https://kompas.id/kategori/internasional/",
			id: 3490418,
			slug: "internasional"
		},
		Tokoh: {
			name: "Tokoh",
			url: "https://kompas.id/kategori/tokoh/",
			id: 4265106,
			slug: "tokoh",
			sub_rubrik: [
				{
					name: "Sosok",
					url: "https://kompas.id/kategori/tokoh/sosok/",
					id: 3491274,
					slug: "sosok"
				},
				{
					name: "Wawancara",
					url: "https://kompas.id/kategori/tokoh/wawancara-tokoh/",
					id: 4143018,
					slug: "wawancara-tokoh"
				},
				{
					name: "Figur",
					url: "https://kompas.id/kategori/tokoh/figur/",
					id: 4143086,
					slug: "figur"
				},
				{
					name: "Nama &amp; Peristiwa",
					url: "https://kompas.id/kategori/tokoh/nama-peristiwa/",
					id: 3491366,
					slug: "nama-peristiwa"
				}
			]
		...
		Olahraga: {
			name: "Olahraga",
			url: "https://kompas.id/kategori/olahraga/",
			id: 3491270,
			slug: "olahraga"
		},
		"Gaya Hidup": {
			name: "Gaya Hidup",
			url: "https://kompas.id/kategori/gaya-hidup/",
			id: 3491278,
			slug: "gaya-hidup",
			sub_rubrik: [
				{
					name: "Kendara",
					url: "https://kompas.id/kategori/gaya-hidup/otomotif/",
					id: 4140394,
					slug: "otomotif"
				},
				{
					name: "Gawai",
					url: "https://kompas.id/kategori/gaya-hidup/gawai/",
					id: 4140422,
					slug: "gawai"
				},
				{
					name: "Kuliner",
					url: "https://kompas.id/kategori/gaya-hidup/kuliner/",
					id: 4141782,
					slug: "kuliner"
				},
				{
					name: "Mode",
					url: "https://kompas.id/kategori/gaya-hidup/aksen/",
					id: 4142170,
					slug: "aksen"
				},
				{
					name: "Properti",
					url: "https://kompas.id/kategori/gaya-hidup/properti/",
					id: 4142194,
					slug: "properti"
				}
			]
		...
		Multimedia: {
			name: "Multimedia",
			url: "https://kompas.id/kategori/multimedia/",
			id: 3491286,
			slug: "multimedia",
			sub_rubrik: [
				{
					name: "Tutur Visual",
					url: "https://kompas.id/multimedia/eksternal/tutur-visual/",
					id: 3491294,
					slug: "tutur-visual"
				},
				{
					name: "Infografik",
					url: "https://kompas.id/multimedia/eksternal/infografik/",
					id: 3491298,
					slug: "infografik"
				}
			]
		...
		Jelajah: {
			name: "Jelajah",
			url: "https://jelajah.kompas.id//",
			id: 3491306,
			slug: "liputan-khusus"
		},
		Video: {
			name: "Video",
			url: "https://kompas.id/kategori/video/",
			id: 3491310,
			slug: "video",
			sub_rubrik: [
				{
					name: "Video Berita",
					url: "https://kompas.id/kategori/video/berita-video/",
					id: 3491314,
					slug: "berita-video"
				},
				{
					name: "Program",
					url: "https://kompas.id/kategori/video/feature/",
					id: 3491318,
					slug: "feature"
				},
				{
					name: "Dokumenter",
					url: "https://kompas.id/kategori/video/dokumenter/",
					id: 3491326,
					slug: "dokumenter"
				},
				{
					name: "Siaran Langsung",
					url: "https://kompas.id/live_stream_categories/video/pentas/",
					id: 3491334,
					slug: "pentas"
				}
			]
		...
		Fotografi: {
			name: "Fotografi",
			url: "https://kompas.id/kategori/foto/",
			id: 3491342,
			slug: "foto",
			sub_rubrik: [
				{
					name: "Galeri Foto",
					url: "https://kompas.id/kategori/foto/galeri-foto/",
					id: 3491350,
					slug: "galeri-foto"
				},
				{
					name: "Foto Cerita",
					url: "https://kompas.id/kategori/foto/foto-cerita/",
					id: 3491354,
					slug: "foto-cerita"
				},
				{
					name: "Klinik Foto",
					url: "https://kompas.id/kategori/foto/klinik-foto-kompas/",
					id: 3491362,
					slug: "klinik-foto-kompas"
				}
			]
		},
		Muda: {
			name: "Muda",
			url: "https://kompas.id/kategori/muda/",
			id: 3491374,
			slug: "muda"
		},
		Hiburan: {
			name: "Hiburan",
			url: "https://kompas.id/kategori/hiburan/",
			id: 3491378,
			slug: "hiburan"
		},
		Sastra: {
			name: "Sastra",
			url: "https://kompas.id/kategori/sastra/",
			id: 3491382,
			slug: "sastra",
			sub_rubrik: [
				{
					name: "Cerpen",
					url: "https://kompas.id/kategori/sastra/cerpen-hiburan/",
					id: 3491386,
					slug: "cerpen-hiburan"
				},
				{
					name: "Puisi",
					url: "https://kompas.id/kategori/sastra/puisi/",
					id: 3491390,
					slug: "puisi"
				}
			]
		...
		Buku: {
			name: "Buku",
			url: "https://kompas.id/kategori/buku/",
			id: 3491398,
			slug: "buku"
		},
		English: {
			name: "English",
			url: "https://kompas.id/kategori/english/",
			id: 3491402,
			slug: "english"
		},
		Perjalanan: {
			name: "Perjalanan",
			url: "https://kompas.id/kategori/perjalanan/",
			id: 3491406,
			slug: "perjalanan"
		},
		"Di Balik Berita": {
			name: "Di Balik Berita",
			url: "https://kompas.id/kategori/di-balik-berita/",
			id: 3491418,
			slug: "di-balik-berita"
		},
		"Arsip Kompas": {
			name: "Arsip Kompas",
			url: "https://kompas.id/kategori/arsip/",
			id: 11075494,
			slug: "arsip"
		}
	}
...
const kompasFooterCss$3 = ".sc-kompas-footer-h{display:block}.sc-kompas-footer-h .sc-kompas-footer{box-sizing:border-box;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;text-align:left}.bg--brand-1.sc-kompas-footer{--tw-bg-opacity:1;background-color:rgba(0,85,154,var(--tw-bg-opacity))}.bg--grey-100.sc-kompas-footer{--tw-bg-opacity:1;background-color:rgba(255,255,255,var(--tw-bg-opacity))}.bg--grey-200.sc-kompas-footer{--tw-bg-opacity:1;background-color:rgba(238,238,238,var(--tw-bg-opacity))}.bg--grey-500.sc-kompas-footer{--tw-bg-opacity:1;background-color:rgba(102,102,102,var(--tw-bg-opacity))}.bg--grey-600.sc-kompas-footer{--tw-bg-opacity:1;background-color:rgba(51,51,51,var(--tw-bg-opacity))}.border--grey-700.sc-kompas-footer{--tw-border-opacity:1;border-color:rgba(0,0,0,var(--tw-border-opacity))}.border--t.sc-kompas-footer{border-top-width:1px}.border--t-solid.sc-kompas-footer{border-top-style:solid}.col--span-1.sc-kompas-footer{grid-column:span 1/span 1}.flex--.sc-kompas-footer{display:flex}.flex--col.sc-kompas-footer{flex-direction:column}.flex--wrap.sc-kompas-footer{flex-wrap:wrap}.font--bold.sc-kompas-footer{font-weight:700}.gap--0.sc-kompas-footer{gap:0}.grid--.sc-kompas-footer{display:grid}.grid--cols-1.sc-kompas-footer{grid-template-columns:repeat(1,minmax(0,1fr))}.hidden--.sc-kompas-footer{display:none}.items--center.sc-kompas-footer{align-items:center}.justify--between.sc-kompas-footer{justify-content:space-between}.leading--none.sc-kompas-footer{line-height:1}.leading--tight.sc-kompas-footer{line-height:1.25}.mb--1.sc-kompas-footer{margin-bottom:.25rem}.mb--2.sc-kompas-footer{margin-bottom:.5rem}.mb--3.sc-kompas-footer{margin-bottom:.75rem}.mb--4.sc-kompas-footer{margin-bottom:1rem}.ml--1.sc-kompas-footer{margin-left:.25rem}.ml--2.sc-kompas-footer{margin-left:.5rem}.mr--1.sc-kompas-footer{margin-right:.25rem}.mr--2.sc-kompas-footer{margin-right:.5rem}.mt--1.sc-kompas-footer{margin-top:.25rem}.mx--auto.sc-kompas-footer{margin-left:auto;margin-right:auto}.no--underline.sc-kompas-footer{text-decoration:none}.p--4.sc-kompas-footer{padding:1rem}.pb--12.sc-kompas-footer{padding-bottom:3rem}.pt--5.sc-kompas-footer{padding-top:1.25rem}.px--2.sc-kompas-footer{padding-left:.5rem;padding-right:.5rem}.px--4.sc-kompas-footer{padding-left:1rem;padding-right:1rem}.py--1.sc-kompas-footer{padding-bottom:.25rem;padding-top:.25rem}.py--8.sc-kompas-footer{padding-bottom:2rem;padding-top:2rem}.rounded--sm.sc-kompas-footer{border-radius:.125rem}.text--base.sc-kompas-footer{font-size:1rem;line-height:1.5rem}.text--grey-100.sc-kompas-footer{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.text--grey-500.sc-kompas-footer{--tw-text-opacity:1;color:rgba(102,102,102,var(--tw-text-opacity))}.text--sm.sc-kompas-footer{font-size:.875rem;line-height:1.25rem}.text--xs.sc-kompas-footer{font-size:.75rem;line-height:1rem}.uppercase--.sc-kompas-footer{text-transform:uppercase}.w--full.sc-kompas-footer{width:100%}.icon.sc-kompas-footer{--tw-text-opacity:1;color:rgba(102,102,102,var(--tw-text-opacity));height:1rem}.icon.sc-kompas-footer svg.sc-kompas-footer{fill:currentColor;display:block;height:1rem}.icon.lg.sc-kompas-footer,.icon.lg.sc-kompas-footer svg.sc-kompas-footer{height:1.5rem}.logo.sc-kompas-footer{padding-top:1.25rem}.logo.sc-kompas-footer svg.sc-kompas-footer{height:2.75rem}.menu--separator.sc-kompas-footer{--tw-border-opacity:1;--tw-text-opacity:1;border-color:rgba(255,255,255,var(--tw-border-opacity));border-right-style:solid;border-right-width:1px;color:rgba(255,255,255,var(--tw-text-opacity));display:flex;padding-left:.25rem;padding-right:.25rem;text-decoration:none}.menu--separator.sc-kompas-footer:last-child{border-right-style:none}@media (min-width:1024px){.lg\\:col--span-2.sc-kompas-footer{grid-column:span 2/span 2}.lg\\:col--span-3.sc-kompas-footer{grid-column:span 3/span 3}.lg\\:flex--.sc-kompas-footer{display:flex}.lg\\:flex--row.sc-kompas-footer{flex-direction:row}.lg\\:gap--4.sc-kompas-footer{gap:1rem}.lg\\:grid--.sc-kompas-footer{display:grid}.lg\\:grid--cols-3.sc-kompas-footer{grid-template-columns:repeat(3,minmax(0,1fr))}.lg\\:grid--cols-4.sc-kompas-footer{grid-template-columns:repeat(4,minmax(0,1fr))}.lg\\:justify--between.sc-kompas-footer{justify-content:space-between}.lg\\:mb--0.sc-kompas-footer{margin-bottom:0}.lg\\:ml--auto.sc-kompas-footer{margin-left:auto}.lg\\:px--0.sc-kompas-footer{padding-left:0;padding-right:0}}";
...
class KompasFooter {
    constructor(hostRef) {
         ...
         */
        this.wordingMessage = "Halo saya perlu informasi mengenai kompas.id";
    }
    render() {
        return (hAsync("footer", { class: "w--full" }, hAsync("kompas-footer-supports", { branding: branding, "wording-message": this.wordingMessage }), hAsync("kompas-footer-products", { branding: branding }), hAsync("kompas-footer-default", { menus: menus })));
    }
    static get style() { return kompasFooterCss$3; }
    static get cmpMeta() {
        return {
            "$flags$": 9,
            "$tagName$": "kompas-footer",
            "$members$": {
                "wordingMessage": [1, "wording-message"]
            },
            "$listeners$": undefined,
            "$lazyBundleId$": "-",
            "$attrsToReflect$": []
...
const kompasFooterCss$2 = ".sc-kompas-footer-default-h{display:block}.sc-kompas-footer-default-h .sc-kompas-footer-default{box-sizing:border-box;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;text-align:left}.bg--brand-1.sc-kompas-footer-default{--tw-bg-opacity:1;background-color:rgba(0,85,154,var(--tw-bg-opacity))}.bg--grey-100.sc-kompas-footer-default{--tw-bg-opacity:1;background-color:rgba(255,255,255,var(--tw-bg-opacity))}.bg--grey-200.sc-kompas-footer-default{--tw-bg-opacity:1;background-color:rgba(238,238,238,var(--tw-bg-opacity))}.bg--grey-500.sc-kompas-footer-default{--tw-bg-opacity:1;background-color:rgba(102,102,102,var(--tw-bg-opacity))}.bg--grey-600.sc-kompas-footer-default{--tw-bg-opacity:1;background-color:rgba(51,51,51,var(--tw-bg-opacity))}.border--grey-700.sc-kompas-footer-default{--tw-border-opacity:1;border-color:rgba(0,0,0,var(--tw-border-opacity))}.border--t.sc-kompas-footer-default{border-top-width:1px}.border--t-solid.sc-kompas-footer-default{border-top-style:solid}.col--span-1.sc-kompas-footer-default{grid-column:span 1/span 1}.flex--.sc-kompas-footer-default{display:flex}.flex--col.sc-kompas-footer-default{flex-direction:column}.flex--wrap.sc-kompas-footer-default{flex-wrap:wrap}.font--bold.sc-kompas-footer-default{font-weight:700}.gap--0.sc-kompas-footer-default{gap:0}.grid--.sc-kompas-footer-default{display:grid}.grid--cols-1.sc-kompas-footer-default{grid-template-columns:repeat(1,minmax(0,1fr))}.hidden--.sc-kompas-footer-default{display:none}.items--center.sc-kompas-footer-default{align-items:center}.justify--between.sc-kompas-footer-default{justify-content:space-between}.leading--none.sc-kompas-footer-default{line-height:1}.leading--tight.sc-kompas-footer-default{line-height:1.25}.mb--1.sc-kompas-footer-default{margin-bottom:.25rem}.mb--2.sc-kompas-footer-default{margin-bottom:.5rem}.mb--3.sc-kompas-footer-default{margin-bottom:.75rem}.mb--4.sc-kompas-footer-default{margin-bottom:1rem}.ml--1.sc-kompas-footer-default{margin-left:.25rem}.ml--2.sc-kompas-footer-default{margin-left:.5rem}.mr--1.sc-kompas-footer-default{margin-right:.25rem}.mr--2.sc-kompas-footer-default{margin-right:.5rem}.mt--1.sc-kompas-footer-default{margin-top:.25rem}.mx--auto.sc-kompas-footer-default{margin-left:auto;margin-right:auto}.no--underline.sc-kompas-footer-default{text-decoration:none}.p--4.sc-kompas-footer-default{padding:1rem}.pb--12.sc-kompas-footer-default{padding-bottom:3rem}.pt--5.sc-kompas-footer-default{padding-top:1.25rem}.px--2.sc-kompas-footer-default{padding-left:.5rem;padding-right:.5rem}.px--4.sc-kompas-footer-default{padding-left:1rem;padding-right:1rem}.py--1.sc-kompas-footer-default{padding-bottom:.25rem;padding-top:.25rem}.py--8.sc-kompas-footer-default{padding-bottom:2rem;padding-top:2rem}.rounded--sm.sc-kompas-footer-default{border-radius:.125rem}.text--base.sc-kompas-footer-default{font-size:1rem;line-height:1.5rem}.text--grey-100.sc-kompas-footer-default{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.text--grey-500.sc-kompas-footer-default{--tw-text-opacity:1;color:rgba(102,102,102,var(--tw-text-opacity))}.text--sm.sc-kompas-footer-default{font-size:.875rem;line-height:1.25rem}.text--xs.sc-kompas-footer-default{font-size:.75rem;line-height:1rem}.uppercase--.sc-kompas-footer-default{text-transform:uppercase}.w--full.sc-kompas-footer-default{width:100%}.icon.sc-kompas-footer-default{--tw-text-opacity:1;color:rgba(102,102,102,var(--tw-text-opacity));height:1rem}.icon.sc-kompas-footer-default svg.sc-kompas-footer-default{fill:currentColor;display:block;height:1rem}.icon.lg.sc-kompas-footer-default,.icon.lg.sc-kompas-footer-default svg.sc-kompas-footer-default{height:1.5rem}.logo.sc-kompas-footer-default{padding-top:1.25rem}.logo.sc-kompas-footer-default svg.sc-kompas-footer-default{height:2.75rem}.menu--separator.sc-kompas-footer-default{--tw-border-opacity:1;--tw-text-opacity:1;border-color:rgba(255,255,255,var(--tw-border-opacity));border-right-style:solid;border-right-width:1px;color:rgba(255,255,255,var(--tw-text-opacity));display:flex;padding-left:.25rem;padding-right:.25rem;text-decoration:none}.menu--separator.sc-kompas-footer-default:last-child{border-right-style:none}@media (min-width:1024px){.lg\\:col--span-2.sc-kompas-footer-default{grid-column:span 2/span 2}.lg\\:col--span-3.sc-kompas-footer-default{grid-column:span 3/span 3}.lg\\:flex--.sc-kompas-footer-default{display:flex}.lg\\:flex--row.sc-kompas-footer-default{flex-direction:row}.lg\\:gap--4.sc-kompas-footer-default{gap:1rem}.lg\\:grid--.sc-kompas-footer-default{display:grid}.lg\\:grid--cols-3.sc-kompas-footer-default{grid-template-columns:repeat(3,minmax(0,1fr))}.lg\\:grid--cols-4.sc-kompas-footer-default{grid-template-columns:repeat(4,minmax(0,1fr))}.lg\\:justify--between.sc-kompas-footer-default{justify-content:space-between}.lg\\:mb--0.sc-kompas-footer-default{margin-bottom:0}.lg\\:ml--auto.sc-kompas-footer-default{margin-left:auto}.lg\\:px--0.sc-kompas-footer-default{padding-left:0;padding-right:0}}";

class KompasFooterDefault {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        /**
         * Label copyright, tidak akan berubah
         */
        this.copyright = "\u00A9 PT Kompas Media Nusantara";
    }
    clean(ob) {
        let res = [];
        for (const key in ob) {
    ...
    mnLeft() {
        ...
        return footerLeft.map(ob => (hAsync("a", { class: "menu--separator", href: ob.url, key: ob.id }, ob.name)));
    }
    mnRight() {
        const { footer_right = "" } = this.menus;
        const footerRight = this.clean(footer_right);
        return footerRight.map(ob => (hAsync("a", { class: "menu--separator", href: ob.url, key: ob.id }, ob.name)));
    }
    render() {
        return (hAsync("div", { class: "bg--grey-600 flex-- flex--col pb--12 pt--5 px--4 text--xs w--full" }, hAsync("div", { class: "flex-- flex--col lg:flex--row mx--auto w--full", style: { maxWidth: "960px" } }, hAsync("div", { class: "flex-- mb--2 lg:mb--0 mr--2 text--grey-100" }, this.copyright), hAsync("div", { class: "flex-- flex--wrap mb--2 lg:mb--0" }, this.mnLeft()), hAsync("div", { class: "flex-- lg:ml--auto" }, this.mnRight()))));
    }
    static get style() { return kompasFooterCss$2; }
    static get cmpMeta() {
        return {
            "$flags$": 9,
            "$tagName$": "kompas-footer-default",
            "$members$": {
                "menus": [8],
                "copyright": [32]
            },
...
var facebookSquare = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M400 32H48A48 48 0 0 0 0 80v352a48 48 0 0 0 48 48h137.25V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.27c-30.81 0-40.42 19.12-40.42 38.73V256h68.78l-11 71.69h-57.78V480H400a48 48 0 0 0 48-48V80a48 48 0 0 0-48-48z"/></svg>`;

var instagram = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z"/></svg>`;

var twitterSquare = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M400 32H48C21.5 32 0 53.5 0 80v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V80c0-26.5-21.5-48-48-48zm-48.9 158.8c.2 2.8.2 5.7.2 8.5 0 86.7-66 186.6-186.6 186.6-37.2 0-71.7-10.8-100.7-29.4 5.3.6 10.4.8 15.8.8 30.7 0 58.9-10.4 81.4-28-28.8-.6-53-19.5-61.3-45.5 10.1 1.5 19.2 1.5 29.6-1.2-30-6.1-52.5-32.5-52.5-64.4v-.8c8.7 4.9 18.9 7.9 29.6 8.3a65.447 65.447 0 0 1-29.2-54.6c0-12.2 3.2-23.4 8.9-33.1 32.3 39.8 80.8 65.8 135.2 68.6-9.3-44.5 24-80.6 64-80.6 18.9 0 35.9 7.9 47.9 20.7 14.8-2.8 29-8.3 41.6-15.8-4.9 15.2-15.2 28-28.8 36.1 13.2-1.4 26-5.1 37.8-10.2-8.9 13.1-20.1 24.7-32.9 34z"/></svg>`;

var youtubeSquare = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M186.8 202.1l95.2 54.1-95.2 54.1V202.1zM448 80v352c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V80c0-26.5 21.5-48 48-48h352c26.5 0 48 21.5 48 48zm-42 176.3s0-59.6-7.6-88.2c-4.2-15.8-16.5-28.2-32.2-32.4C337.9 128 224 128 224 128s-113.9 0-142.2 7.7c-15.7 4.2-28 16.6-32.2 32.4-7.6 28.5-7.6 88.2-7.6 88.2s0 59.6 7.6 88.2c4.2 15.8 16.5 27.7 32.2 31.9C110.1 384 224 384 224 384s113.9 0 142.2-7.7c15.7-4.2 28-16.1 32.2-31.9 7.6-28.5 7.6-88.1 7.6-88.1z"/></svg>`;

var logo = `<?xml version="1.0" encoding="utf-8"?>
<!-- Generator: Adobe Illustrator 17.1.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 390.7 100" enable-background="new 0 0 390.7 100" xml:space="preserve">
<g id="Layer_1">

		<image display="none" overflow="visible" width="231" height="60" xlink:href="data:image/png;base64," transform="matrix(1 0 0 1 91 30.3333)">
	</image>
	<g>
		<path fill="#FFFFFF" d="M34.5,70.2H4.6v-2.5h9.3L25.6,7.1h-8.2V4.5h29.8v2.6h-9.4L26.2,67.7h8.3V70.2z M74.7,70.2H43.2v-2.5l9.1,0
			L33.1,35.9L64.5,7.1h-9.9V4.5h22.6v2.6H69L43.1,31l22.9,36.7l8.7,0V70.2z"/>
		<path fill="#FFFFFF" d="M77,45.3C77,36,80.5,27,87.6,18.4c4.1-5,8.4-8.8,13.1-11.4c4.7-2.6,9.6-3.8,14.8-3.8
			c7,0,12.8,2.5,17.3,7.5c4.5,5,6.8,11.3,6.8,19c0,9.1-3.5,18-10.5,26.7c-8.3,10.2-17.7,15.3-28.1,15.3c-7,0-12.8-2.5-17.2-7.5
			C79.2,59.2,77,52.9,77,45.3z M114.1,5.6c-4,0-7.4,1.3-10.2,4c-2.8,2.7-5.2,6.7-7.3,12.2c-2.1,5.5-3.6,11-4.7,16.7
			c-1.1,5.6-1.6,10.7-1.6,15.3c0,10.3,4,15.4,12,15.4c7.7,0,13.5-5.5,17.6-16.4c1.8-4.9,3.3-10.3,4.4-16.2c1.1-5.9,1.6-11,1.6-15.5
			c0,0.4,0.1,0.6,0.4,0.8c0.3,0.2,0.9,0.3,1.7,0.3v0.3h-6.9V96z"/>
	</g>
</g>
<g id="Layer_2" display="none">
		...
		<text transform="matrix(1 0 0 1 88.1335 -125.3329)" display="inline" fill="#00599A" font-family="'Bodoni-BTItalic'" font-size="59">KOMPAS</text>

		<text transform="matrix(1 0 0 1 86.7333 -109.7167)" display="inline" fill="#00599A" font-family="'ChronicleDisplay-Bold'" font-size="11" letter-spacing="2">AMANAT HATI NURANI RAKYAT</text>
</g>
</svg>
`;
...
var telephone = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M493.4 24.6l-104-24c-11.3-2.6-22.9 3.3-27.5 13.9l-48 112c-4.2 9.8-1.4 21.3 6.9 28l60.6 49.6c-36 76.7-98.9 140.5-177.2 177.2l-49.6-60.6c-6.8-8.3-18.2-11.1-28-6.9l-112 48C3.9 366.5-2 378.1.6 389.4l24 104C27.1 504.2 36.7 512 48 512c256.1 0 464-207.5 464-464 0-11.2-7.7-20.9-18.6-23.4z"/></svg>`;

const kompasFooterCss$1 = ".sc-kompas-footer-products-h{display:block}.sc-kompas-footer-products-h .sc-kompas-footer-products{box-sizing:border-box;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;text-align:left}.bg--brand-1.sc-kompas-footer-products{--tw-bg-opacity:1;background-color:rgba(0,85,154,var(--tw-bg-opacity))}.bg--grey-100.sc-kompas-footer-products{--tw-bg-opacity:1;background-color:rgba(255,255,255,var(--tw-bg-opacity))}.bg--grey-200.sc-kompas-footer-products{--tw-bg-opacity:1;background-color:rgba(238,238,238,var(--tw-bg-opacity))}.bg--grey-500.sc-kompas-footer-products{--tw-bg-opacity:1;background-color:rgba(102,102,102,var(--tw-bg-opacity))}.bg--grey-600.sc-kompas-footer-products{--tw-bg-opacity:1;background-color:rgba(51,51,51,var(--tw-bg-opacity))}.border--grey-700.sc-kompas-footer-products{--tw-border-opacity:1;border-color:rgba(0,0,0,var(--tw-border-opacity))}.border--t.sc-kompas-footer-products{border-top-width:1px}.border--t-solid.sc-kompas-footer-products{border-top-style:solid}.col--span-1.sc-kompas-footer-products{grid-column:span 1/span 1}.flex--.sc-kompas-footer-products{display:flex}.flex--col.sc-kompas-footer-products{flex-direction:column}.flex--wrap.sc-kompas-footer-products{flex-wrap:wrap}.font--bold.sc-kompas-footer-products{font-weight:700}.gap--0.sc-kompas-footer-products{gap:0}.grid--.sc-kompas-footer-products{display:grid}.grid--cols-1.sc-kompas-footer-products{grid-template-columns:repeat(1,minmax(0,1fr))}.hidden--.sc-kompas-footer-products{display:none}.items--center.sc-kompas-footer-products{align-items:center}.justify--between.sc-kompas-footer-products{justify-content:space-between}.leading--none.sc-kompas-footer-products{line-height:1}.leading--tight.sc-kompas-footer-products{line-height:1.25}.mb--1.sc-kompas-footer-products{margin-bottom:.25rem}.mb--2.sc-kompas-footer-products{margin-bottom:.5rem}.mb--3.sc-kompas-footer-products{margin-bottom:.75rem}.mb--4.sc-kompas-footer-products{margin-bottom:1rem}.ml--1.sc-kompas-footer-products{margin-left:.25rem}.ml--2.sc-kompas-footer-products{margin-left:.5rem}.mr--1.sc-kompas-footer-products{margin-right:.25rem}.mr--2.sc-kompas-footer-products{margin-right:.5rem}.mt--1.sc-kompas-footer-products{margin-top:.25rem}.mx--auto.sc-kompas-footer-products{margin-left:auto;margin-right:auto}.no--underline.sc-kompas-footer-products{text-decoration:none}.p--4.sc-kompas-footer-products{padding:1rem}.pb--12.sc-kompas-footer-products{padding-bottom:3rem}.pt--5.sc-kompas-footer-products{padding-top:1.25rem}.px--2.sc-kompas-footer-products{padding-left:.5rem;padding-right:.5rem}.px--4.sc-kompas-footer-products{padding-left:1rem;padding-right:1rem}.py--1.sc-kompas-footer-products{padding-bottom:.25rem;padding-top:.25rem}.py--8.sc-kompas-footer-products{padding-bottom:2rem;padding-top:2rem}.rounded--sm.sc-kompas-footer-products{border-radius:.125rem}.text--base.sc-kompas-footer-products{font-size:1rem;line-height:1.5rem}.text--grey-100.sc-kompas-footer-products{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.text--grey-500.sc-kompas-footer-products{--tw-text-opacity:1;color:rgba(102,102,102,var(--tw-text-opacity))}.text--sm.sc-kompas-footer-products{font-size:.875rem;line-height:1.25rem}.text--xs.sc-kompas-footer-products{font-size:.75rem;line-height:1rem}.uppercase--.sc-kompas-footer-products{text-transform:uppercase}.w--full.sc-kompas-footer-products{width:100%}.icon.sc-kompas-footer-products{--tw-text-opacity:1;color:rgba(102,102,102,var(--tw-text-opacity));height:1rem}.icon.sc-kompas-footer-products svg.sc-kompas-footer-products{fill:currentColor;display:block;height:1rem}.icon.lg.sc-kompas-footer-products,.icon.lg.sc-kompas-footer-products svg.sc-kompas-footer-products{height:1.5rem}.logo.sc-kompas-footer-products{padding-top:1.25rem}.logo.sc-kompas-footer-products svg.sc-kompas-footer-products{height:2.75rem}.menu--separator.sc-kompas-footer-products{--tw-border-opacity:1;--tw-text-opacity:1;border-color:rgba(255,255,255,var(--tw-border-opacity));border-right-style:solid;border-right-width:1px;color:rgba(255,255,255,var(--tw-text-opacity));display:flex;padding-left:.25rem;padding-right:.25rem;text-decoration:none}.menu--separator.sc-kompas-footer-products:last-child{border-right-style:none}@media (min-width:1024px){.lg\\:col--span-2.sc-kompas-footer-products{grid-column:span 2/span 2}.lg\\:col--span-3.sc-kompas-footer-products{grid-column:span 3/span 3}.lg\\:flex--.sc-kompas-footer-products{display:flex}.lg\\:flex--row.sc-kompas-footer-products{flex-direction:row}.lg\\:gap--4.sc-kompas-footer-products{gap:1rem}.lg\\:grid--.sc-kompas-footer-products{display:grid}.lg\\:grid--cols-3.sc-kompas-footer-products{grid-template-columns:repeat(3,minmax(0,1fr))}.lg\\:grid--cols-4.sc-kompas-footer-products{grid-template-columns:repeat(4,minmax(0,1fr))}.lg\\:justify--between.sc-kompas-footer-products{justify-content:space-between}.lg\\:mb--0.sc-kompas-footer-products{margin-bottom:0}.lg\\:ml--auto.sc-kompas-footer-products{margin-left:auto}.lg\\:px--0.sc-kompas-footer-products{padding-left:0;padding-right:0}}";

class KompasFooterProducts {
    constructor(hostRef) {
        registerInstance(this, hostRef);
    }
    about() {
        ...
        const aboutLinks = () => {
            ...
            const list = links.map(ob => {
                return hAsync("a", { class: "no--underline text--grey-100  text--xs", href: ob.url, title: ob.label, target: "_blank" }, ob.label);
            });
            return (hAsync("div", { class: "mb--4" }, hAsync("div", { class: "flex-- font--bold mb--3 text--grey-100 text--sm uppercase--" }, "Tentang"), hAsync("div", { class: "flex-- flex--col" }, list)));
        };
        const otherLinks = () => {
            const { links } = others;
            const list = links.map(ob => {
            ...
            return (hAsync("div", { class: "mb4" }, hAsync("div", { class: "flex-- font--bold mb--3 text--grey-100 text--sm uppercase--" }, "Lainnya"), hAsync("div", { class: "flex-- flex--col" }, list)));
        };
        return (hAsync("div", { class: "bg--brand-1 p--4 text--grey-100" }, aboutLinks(), otherLinks(), hAsync("div", { class: "logo", innerHTML: logo })));
    }
    items() {
        const { business_division, editorial_division, products } = this.branding;
        const { address: businessAddress = "", phones: businessPhones = [] } = business_division;
        const advertorial = () => {
            const telephones = businessPhones.map(ob => {
                return (hAsync("a", { class: "no--underline text--grey-500", href: `tel:${ob.number.replace(/\s/g, "")}` }, ob.number));
            });
            return (hAsync("div", { class: "mb--4 lg:mb--0" }, hAsync("div", { class: "flex-- font--bold mb--3 text--grey-500 text--sm uppercase--" }, "Kantor Iklan"), hAsync("div", { class: "flex-- mb--2" }, hAsync("span", { class: "icon mr--1 mt--1", innerHTML: mapMarkerAlt }), hAsync("div", { class: "mb--2 text--xs", innerHTML: businessAddress })), hAsync("div", { class: "flex-- mb--2" }, hAsync("span", { class: "icon mr--1 mt--1", innerHTML: telephone }), hAsync("div", { class: "flex-- flex--col text--xs" }, telephones))));
        };
        ...
        const editorial = () => {
            ...
            return (hAsync("div", { class: "mb--4" }, hAsync("div", { class: "flex-- font--bold mb--3 text--grey-500 text--sm uppercase--" }, "Kantor Redaksi"), hAsync("div", { class: "flex-- mb--2" }, hAsync("span", { class: "icon mr--1 mt--1", innerHTML: mapMarkerAlt }), hAsync("div", { class: "mb--2 text--xs", innerHTML: editorialAddress })), hAsync("div", { class: "flex-- mb--2" }, hAsync("span", { class: "icon mr--1 mt--1", innerHTML: telephone }), hAsync("div", { class: "flex-- flex--col text--xs" }, telephones))));
        };
        const businessProducts = () => {
            const { business: { label = "", items = [] } } = products;
            const list = items.map(ob => {
                return hAsync("a", { class: "no--underline text--grey-500 text--xs", href: ob.url, title: ob.name, target: "blank" }, ob.name);
            });
            return (hAsync("div", null, hAsync("div", { class: "flex-- font--bold mb--3 text--grey-500 text--sm uppercase--" }, label), hAsync("div", { class: "flex-- flex--col" }, list)));
        };
        const editorialProducts = () => {
            ...
            return (hAsync("div", { class: "mb--4 lg:mb--0" }, hAsync("div", { class: "flex-- font--bold mb--3 text--grey-500 text--sm uppercase--" }, label), hAsync("div", { class: "flex-- flex--col" }, list)));
        };
        return (hAsync("div", { class: "col--span-1 lg:col--span-2 lg:gap--4 lg:grid-- lg:grid--cols-3 p--4 lg:px--0" }, hAsync("div", null, editorial(), advertorial()), hAsync("div", null, editorialProducts()), hAsync("div", null, businessProducts())));
    }
    profile() {
        const icons = [facebookSquare, twitterSquare, instagram, youtubeSquare];
        const { profile: { text: profileText = "" }, social_accounts: { items: socialAccounts = [] } } = this.branding;
        const accounts = socialAccounts.map((ob, key) => {
            return (hAsync("a", { class: "flex-- items--center leading--none mb--1 no--underline text--grey-500", href: ob.url, title: ob.name, rel: "nofollow", target: "_blank" }, hAsync("span", { class: "icon", innerHTML: icons[key] }), hAsync("span", { class: "bg--grey-500 leading--none ml--2 px--2 py--1 rounded--sm text--grey-100" }, ob.name)));
        });
        return (hAsync("div", { class: "p--4 lg:px--0 text--grey-500 text--xs" }, hAsync("div", { class: "mb--4", innerHTML: profileText }), hAsync("div", null, accounts)));
    }
    render() {
        return (hAsync("div", { class: "bg--grey-200 flex-- w--full" }, hAsync("div", { class: "gap--0 grid-- grid--cols-1 mx--auto text--grey-500 w--full lg:gap--4 lg:grid--cols-4", style: { maxWidth: "960px" } }, this.profile(), this.items(), this.about())));
    }
    static get style() { return kompasFooterCss$1; }
    static get cmpMeta() {
        return {
            "$flags$": 9,
            "$tagName$": "kompas-footer-products",
            "$members$": {
                "branding": [8]
            },
            "$listeners$": undefined,
...
var chevronRight = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z"/></svg>`;

var email = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M464 64H48C21.49 64 0 85.49 0 112v288c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V112c0-26.51-21.49-48-48-48zm0 48v40.805c-22.422 18.259-58.168 46.651-134.587 106.49-16.841 13.247-50.201 45.072-73.413 44.701-23.208.375-56.579-31.459-73.413-44.701C106.18 199.465 70.425 171.067 48 152.805V112h416zM48 400V214.398c22.914 18.251 55.409 43.862 104.938 82.646 21.857 17.205 60.134 55.186 103.062 54.955 42.717.231 80.509-37.199 103.053-54.947 49.528-38.783 82.032-64.401 104.947-82.653V400H48z"/></svg>`;

var hour = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6z"/></svg>`;

var whatsappIcon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480l117.7-30.9c32.4 17.7 68.9 27 106.1 27h.1c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.2 0-65.7-8.9-94-25.7l-6.7-4-69.8 18.3L72 359.2l-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 56.2 81.2 56.1 130.5 0 101.8-84.9 184.6-186.6 184.6zm101.2-138.2c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.6-14.3 18-17.6 21.8-3.2 3.7-6.5 4.2-12 1.4-32.6-16.3-54-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.3 1.8-3.7.9-6.9-.5-9.7-1.4-2.8-12.5-30.1-17.1-41.2-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2-3.7 0-9.7 1.4-14.8 6.9-5.1 5.6-19.4 19-19.4 46.3 0 27.3 19.9 53.7 22.6 57.4 2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.6 32.8-13.4 37.4-26.4 4.6-13 4.6-24.1 3.2-26.4-1.3-2.5-5-3.9-10.5-6.6z"/></svg>`;

const kompasFooterCss = ".sc-kompas-footer-supports-h{display:block}.sc-kompas-footer-supports-h .sc-kompas-footer-supports{box-sizing:border-box;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;text-align:left}.bg--brand-1.sc-kompas-footer-supports{--tw-bg-opacity:1;background-color:rgba(0,85,154,var(--tw-bg-opacity))}.bg--grey-100.sc-kompas-footer-supports{--tw-bg-opacity:1;background-color:rgba(255,255,255,var(--tw-bg-opacity))}.bg--grey-200.sc-kompas-footer-supports{--tw-bg-opacity:1;background-color:rgba(238,238,238,var(--tw-bg-opacity))}.bg--grey-500.sc-kompas-footer-supports{--tw-bg-opacity:1;background-color:rgba(102,102,102,var(--tw-bg-opacity))}.bg--grey-600.sc-kompas-footer-supports{--tw-bg-opacity:1;background-color:rgba(51,51,51,var(--tw-bg-opacity))}.border--grey-700.sc-kompas-footer-supports{--tw-border-opacity:1;border-color:rgba(0,0,0,var(--tw-border-opacity))}.border--t.sc-kompas-footer-supports{border-top-width:1px}.border--t-solid.sc-kompas-footer-supports{border-top-style:solid}.col--span-1.sc-kompas-footer-supports{grid-column:span 1/span 1}.flex--.sc-kompas-footer-supports{display:flex}.flex--col.sc-kompas-footer-supports{flex-direction:column}.flex--wrap.sc-kompas-footer-supports{flex-wrap:wrap}.font--bold.sc-kompas-footer-supports{font-weight:700}.gap--0.sc-kompas-footer-supports{gap:0}.grid--.sc-kompas-footer-supports{display:grid}.grid--cols-1.sc-kompas-footer-supports{grid-template-columns:repeat(1,minmax(0,1fr))}.hidden--.sc-kompas-footer-supports{display:none}.items--center.sc-kompas-footer-supports{align-items:center}.justify--between.sc-kompas-footer-supports{justify-content:space-between}.leading--none.sc-kompas-footer-supports{line-height:1}.leading--tight.sc-kompas-footer-supports{line-height:1.25}.mb--1.sc-kompas-footer-supports{margin-bottom:.25rem}.mb--2.sc-kompas-footer-supports{margin-bottom:.5rem}.mb--3.sc-kompas-footer-supports{margin-bottom:.75rem}.mb--4.sc-kompas-footer-supports{margin-bottom:1rem}.ml--1.sc-kompas-footer-supports{margin-left:.25rem}.ml--2.sc-kompas-footer-supports{margin-left:.5rem}.mr--1.sc-kompas-footer-supports{margin-right:.25rem}.mr--2.sc-kompas-footer-supports{margin-right:.5rem}.mt--1.sc-kompas-footer-supports{margin-top:.25rem}.mx--auto.sc-kompas-footer-supports{margin-left:auto;margin-right:auto}.no--underline.sc-kompas-footer-supports{text-decoration:none}.p--4.sc-kompas-footer-supports{padding:1rem}.pb--12.sc-kompas-footer-supports{padding-bottom:3rem}.pt--5.sc-kompas-footer-supports{padding-top:1.25rem}.px--2.sc-kompas-footer-supports{padding-left:.5rem;padding-right:.5rem}.px--4.sc-kompas-footer-supports{padding-left:1rem;padding-right:1rem}.py--1.sc-kompas-footer-supports{padding-bottom:.25rem;padding-top:.25rem}.py--8.sc-kompas-footer-supports{padding-bottom:2rem;padding-top:2rem}.rounded--sm.sc-kompas-footer-supports{border-radius:.125rem}.text--base.sc-kompas-footer-supports{font-size:1rem;line-height:1.5rem}.text--grey-100.sc-kompas-footer-supports{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.text--grey-500.sc-kompas-footer-supports{--tw-text-opacity:1;color:rgba(102,102,102,var(--tw-text-opacity))}.text--sm.sc-kompas-footer-supports{font-size:.875rem;line-height:1.25rem}.text--xs.sc-kompas-footer-supports{font-size:.75rem;line-height:1rem}.uppercase--.sc-kompas-footer-supports{text-transform:uppercase}.w--full.sc-kompas-footer-supports{width:100%}.icon.sc-kompas-footer-supports{--tw-text-opacity:1;color:rgba(102,102,102,var(--tw-text-opacity));height:1rem}.icon.sc-kompas-footer-supports svg.sc-kompas-footer-supports{fill:currentColor;display:block;height:1rem}.icon.lg.sc-kompas-footer-supports,.icon.lg.sc-kompas-footer-supports svg.sc-kompas-footer-supports{height:1.5rem}.logo.sc-kompas-footer-supports{padding-top:1.25rem}.logo.sc-kompas-footer-supports svg.sc-kompas-footer-supports{height:2.75rem}.menu--separator.sc-kompas-footer-supports{--tw-border-opacity:1;--tw-text-opacity:1;border-color:rgba(255,255,255,var(--tw-border-opacity));border-right-style:solid;border-right-width:1px;color:rgba(255,255,255,var(--tw-text-opacity));display:flex;padding-left:.25rem;padding-right:.25rem;text-decoration:none}.menu--separator.sc-kompas-footer-supports:last-child{border-right-style:none}@media (min-width:1024px){.lg\\:col--span-2.sc-kompas-footer-supports{grid-column:span 2/span 2}.lg\\:col--span-3.sc-kompas-footer-supports{grid-column:span 3/span 3}.lg\\:flex--.sc-kompas-footer-supports{display:flex}.lg\\:flex--row.sc-kompas-footer-supports{flex-direction:row}.lg\\:gap--4.sc-kompas-footer-supports{gap:1rem}.lg\\:grid--.sc-kompas-footer-supports{display:grid}.lg\\:grid--cols-3.sc-kompas-footer-supports{grid-template-columns:repeat(3,minmax(0,1fr))}.lg\\:grid--cols-4.sc-kompas-footer-supports{grid-template-columns:repeat(4,minmax(0,1fr))}.lg\\:justify--between.sc-kompas-footer-supports{justify-content:space-between}.lg\\:mb--0.sc-kompas-footer-supports{margin-bottom:0}.lg\\:ml--auto.sc-kompas-footer-supports{margin-left:auto}.lg\\:px--0.sc-kompas-footer-supports{padding-left:0;padding-right:0}}";

class KompasFooterSupports {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        /**
         * wording untuk chat whatsapp & email
    ...
    items() {
        ...
        res = res.map(o => {
            let sections = (hAsync("div", { class: "flex-- flex--col leading--tight text--sm" }, hAsync("strong", null, o.label), hAsync("span", null, o.sublabel)));
            if (o.action) {
                sections = (hAsync("a", { class: "flex-- flex--col leading--tight text--sm", href: o.action, target: "_blank" }, hAsync("strong", null, o.label), hAsync("span", null, o.sublabel)));
            }
            return (hAsync("div", { class: "flex-- items--center mb--4 lg:mb--0" }, hAsync("span", { class: "icon lg mr--2", innerHTML: o.icon }), sections));
        });
        return (hAsync("div", { class: "col--span-1 lg:col--span-3 flex-- flex--col lg:flex--row lg:justify--between" }, res));
    }
    phoneNumberFormatter(rawNumber) {
    ...
    label() {
        ...
        return (hAsync("div", null, hAsync("strong", null, first), hAsync("span", { class: "ml--1" }, second)));
    }
    render() {
        return (hAsync("div", { class: "bg--grey-100 border--grey-700 border--t border--t-solid flex-- px--4 py--8 w--full" }, hAsync("div", { class: "gap--0 lg:gap--4 grid-- grid--cols-1 lg:grid--cols-4 mx--auto text--grey-500 w--full", style: { maxWidth: "960px" } }, hAsync("div", { class: "flex-- items--center justify--between mb--4 lg:mb--0 uppercase--" }, this.label(), hAsync("span", { class: "flex-- icon", innerHTML: chevronRight })), this.items())));
    }
    static get style() { return kompasFooterCss; }
    static get cmpMeta() {
        return {
            "$flags$": 9,
            "$tagName$": "kompas-footer-supports",
            "$members$": {
                "branding": [8],
                "wordingMessage": [1, "wording-message"]
            },
...
var chevronDown = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M207.029 381.476L12.686 187.132c-9.373-9.373-9.373-24.569 0-33.941l22.667-22.667c9.357-9.357 24.522-9.375 33.901-.04L224 284.505l154.745-154.021c9.379-9.335 24.544-9.317 33.901.04l22.667 22.667c9.373 9.373 9.373 24.569 0 33.941L240.971 381.476c-9.373 9.372-24.569 9.372-33.942 0z"/></svg>`;

var chevronUp = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M240.971 130.524l194.343 194.343c9.373 9.373 9.373 24.569 0 33.941l-22.667 22.667c-9.357 9.357-24.522 9.375-33.901.04L224 227.495 69.255 381.516c-9.379 9.335-24.544 9.317-33.901-.04l-22.667-22.667c-9.373-9.373-9.373-24.569 0-33.941L207.03 130.525c9.372-9.373 24.568-9.373 33.941-.001z"/></svg>`;

const kompasHeaderAccountCss$3 = ".sc-kompas-header-account-h{display:block}.sc-kompas-header-account-h .sc-kompas-header-account{box-sizing:border-box;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji}.header-account-menu--item.sc-kompas-header-account{align-items:center;border-radius:.125rem;display:flex;flex-direction:row;padding:.5rem;transition-duration:.15s;transition-property:background-color,border-color,color,fill,stroke,opacity,box-shadow,transform,filter,-webkit-backdrop-filter;transition-property:background-color,border-color,color,fill,stroke,opacity,box-shadow,transform,filter,backdrop-filter;transition-property:background-color,border-color,color,fill,stroke,opacity,box-shadow,transform,filter,backdrop-filter,-webkit-backdrop-filter;transition-timing-function:cubic-bezier(.4,0,.2,1)}.header-account-menu--item.sc-kompas-header-account:hover{--tw-bg-opacity:1;background-color:rgba(238,238,238,var(--tw-bg-opacity))}.header-account-menu--title.sc-kompas-header-account{flex-grow:1;font-size:1rem;font-weight:700;line-height:1.5rem;margin-left:1rem;margin-right:1rem}.header-account-menu--notification-info.sc-kompas-header-account{--tw-bg-opacity:1;--tw-text-opacity:1;align-items:center;background-color:rgba(255,122,0,var(--tw-bg-opacity));border-radius:1.5rem;color:rgba(255,255,255,var(--tw-text-opacity));display:flex;font-size:.875rem;height:1.75rem;justify-content:center;line-height:1.25rem;width:1.75rem}.header-account-help-center--item.sc-kompas-header-account{align-items:center;display:flex;flex-direction:row;padding-left:.5rem;padding-right:.5rem}.header-account-help-center--content.sc-kompas-header-account{display:flex;flex-direction:column;flex-grow:1;font-size:1rem;line-height:1.5rem;line-height:1rem;margin-left:1rem;margin-right:1rem;row-gap:.5rem}.header-account--membership-icon.sc-kompas-header-account{bottom:-3px;position:absolute;right:-4px}.header-account--notification-indicator.sc-kompas-header-account{--tw-bg-opacity:1;background-color:rgba(255,122,0,var(--tw-bg-opacity));border-radius:9999px;height:.5rem;position:absolute;right:-1px;top:0;width:.5rem}.header-account-sidebar.sc-kompas-header-account{--tw-bg-opacity:1;--tw-shadow:0 10px 15px -3px rgba(0,0,0,.1),0 4px 6px -2px rgba(0,0,0,.05);--tw-border-opacity:1;background-color:rgba(255,255,255,var(--tw-bg-opacity));border-color:rgba(238,238,238,var(--tw-border-opacity));border-width:1px;bottom:0;box-shadow:var(--tw-ring-offset-shadow,0 0 #0000),var(--tw-ring-shadow,0 0 #0000),var(--tw-shadow);display:flex;flex-direction:column;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;font-size:.875rem;height:100vh;line-height:1.25rem;overflow-y:scroll;position:fixed;right:0;top:0;width:19rem;z-index:10}.icon-xs.sc-kompas-header-account svg.sc-kompas-header-account{height:.75rem;width:.75rem}.icon-sm.sc-kompas-header-account svg.sc-kompas-header-account{height:1rem;width:1rem}.icon-md.sc-kompas-header-account svg.sc-kompas-header-account{height:1.25rem;width:1.25rem}.icon-white.sc-kompas-header-account{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.icon-white.sc-kompas-header-account svg.sc-kompas-header-account{fill:currentColor}.icon-blue-600.sc-kompas-header-account{--tw-text-opacity:1;color:rgba(3,86,168,var(--tw-text-opacity))}.icon-blue-600.sc-kompas-header-account svg.sc-kompas-header-account{fill:currentColor}.icon-grey-400.sc-kompas-header-account{--tw-text-opacity:1;color:rgba(153,153,153,var(--tw-text-opacity))}.icon-grey-400.sc-kompas-header-account svg.sc-kompas-header-account{fill:currentColor}.sc-kompas-header-account::-webkit-scrollbar{width:4px}.sc-kompas-header-account::-webkit-scrollbar-track{background:transparent}.sc-kompas-header-account::-webkit-scrollbar-thumb{background:#0356a8;border-radius:100px}.sc-kompas-header-account::-webkit-scrollbar-thumb:hover{background:#0356a8}";

class KompasHeaderAccount {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        /**
        ...
        this.getInitialUserName = () => {
            var _a;
            if (!((_a = this.formattedUserData) === null || _a === void 0 ? void 0 : _a.userName.length))
                return false;
         ...
         */
        this.accountSidebar = () => {
            return (hAsync("div", { class: "header-account-sidebar", style: { marginTop: `${this.sidebarTopSpacing}px` } }, hAsync("kompas-header-account-profile", { "user-initial-name": this.getInitialUserName(), userData: this.formattedUserData }), hAsync("kompas-header-account-menu", { "manage-account-url": this.manageAccountUrl, "logout-url": this.logoutUrl, "notification-total": this.notificationTotal }), hAsync("kompas-header-account-help-center", null)));
        };
    }
    /**
    ...
    account() {
        ...
        const notificationIndicator = () => {
            if (!this.notificationTotal)
                return;
            return (hAsync("div", { class: "header-account--notification-indicator" }));
        };
        /**
        ...
        return (hAsync("a", { onClick: () => toggleDropdown(), class: "cursor-pointer" }, hAsync("div", { class: "flex flex-row items-center self-center" }, !this.getInitialUserName() ?
            ...
            :
                hAsync("div", { class: "flex bg-grey-100 rounded-full h-6 w-6 items-center justify-center relative" }, hAsync("span", { class: "capitalize text-xs text-blue-600 font-bold" }, this.getInitialUserName()), notificationIndicator(), membershipIcon()), hAsync("div", { class: "ml-3 icon-sm icon-white", innerHTML: this.isShowDropdown ? chevronUp : chevronDown }))));
    }
    render() {
        return (hAsync("div", null, this.account(), this.isShowDropdown ? this.accountSidebar() : ""));
    }
    componentWillRender() {
        /**
    ...
    static get style() { return kompasHeaderAccountCss$3; }
    static get cmpMeta() {
        return {
            "$flags$": 9,
            "$tagName$": "kompas-header-account",
            "$members$": {
                "logoutUrl": [1, "logout-url"],
                "manageAccountUrl": [1, "manage-account-url"],
                "notificationTotal": [2, "notification-total"],
                "userData": [8, "user-data"],
                "sidebarTopSpacing": [2, "sidebar-top-spacing"],
                "isShowDropdown": [32]
            },
            "$listeners$": undefined,
            "$lazyBundleId$": "-",
...
var phoneAltIcon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M497.39 361.8l-112-48a24 24 0 0 0-28 6.9l-49.6 60.6A370.66 370.66 0 0 1 130.6 204.11l60.6-49.6a23.94 23.94 0 0 0 6.9-28l-48-112A24.16 24.16 0 0 0 122.6.61l-104 24A24 24 0 0 0 0 48c0 256.5 207.9 464 464 464a24 24 0 0 0 23.4-18.6l24-104a24.29 24.29 0 0 0-14.01-27.6z"/></svg>`;

var copyIcon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M320 448v40c0 13.255-10.745 24-24 24H24c-13.255 0-24-10.745-24-24V120c0-13.255 10.745-24 24-24h72v296c0 30.879 25.121 56 56 56h168zm0-344V0H152c-13.255 0-24 10.745-24 24v368c0 13.255 10.745 24 24 24h272c13.255 0 24-10.745 24-24V128H344c-13.2 0-24-10.8-24-24zm120.971-31.029L375.029 7.029A24 24 0 0 0 358.059 0H352v96h96v-6.059a24 24 0 0 0-7.029-16.97z"/></svg>`;

var envelopeIcon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M502.3 190.8c3.9-3.1 9.7-.2 9.7 4.7V400c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V195.6c0-5 5.7-7.8 9.7-4.7 22.4 17.4 52.1 39.5 154.1 113.6 21.1 15.4 56.7 47.8 92.2 47.6 35.7.3 72-32.8 92.3-47.6 102-74.1 131.6-96.3 154-113.7zM256 320c23.2.4 56.6-29.2 73.4-41.4 132.7-96.3 142.8-104.7 173.4-128.7 5.8-4.5 9.2-11.5 9.2-18.9v-19c0-26.5-21.5-48-48-48H48C21.5 64 0 85.5 0 112v19c0 7.4 3.4 14.3 9.2 18.9 30.6 23.9 40.7 32.4 173.4 128.7 16.8 12.2 50.2 41.8 73.4 41.4z"/></svg>`;

var clockIcon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M256,8C119,8,8,119,8,256S119,504,256,504,504,393,504,256,393,8,256,8Zm92.49,313h0l-20,25a16,16,0,0,1-22.49,2.5h0l-67-49.72a40,40,0,0,1-15-31.23V112a16,16,0,0,1,16-16h32a16,16,0,0,1,16,16V256l58,42.5A16,16,0,0,1,348.49,321Z"/></svg>`;

const kompasHeaderAccountCss$2 = ".sc-kompas-header-account-help-center-h{display:block}.sc-kompas-header-account-help-center-h .sc-kompas-header-account-help-center{box-sizing:border-box;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji}.header-account-menu--item.sc-kompas-header-account-help-center{align-items:center;border-radius:.125rem;display:flex;flex-direction:row;padding:.5rem;transition-duration:.15s;transition-property:background-color,border-color,color,fill,stroke,opacity,box-shadow,transform,filter,-webkit-backdrop-filter;transition-property:background-color,border-color,color,fill,stroke,opacity,box-shadow,transform,filter,backdrop-filter;transition-property:background-color,border-color,color,fill,stroke,opacity,box-shadow,transform,filter,backdrop-filter,-webkit-backdrop-filter;transition-timing-function:cubic-bezier(.4,0,.2,1)}.header-account-menu--item.sc-kompas-header-account-help-center:hover{--tw-bg-opacity:1;background-color:rgba(238,238,238,var(--tw-bg-opacity))}.header-account-menu--title.sc-kompas-header-account-help-center{flex-grow:1;font-size:1rem;font-weight:700;line-height:1.5rem;margin-left:1rem;margin-right:1rem}.header-account-menu--notification-info.sc-kompas-header-account-help-center{--tw-bg-opacity:1;--tw-text-opacity:1;align-items:center;background-color:rgba(255,122,0,var(--tw-bg-opacity));border-radius:1.5rem;color:rgba(255,255,255,var(--tw-text-opacity));display:flex;font-size:.875rem;height:1.75rem;justify-content:center;line-height:1.25rem;width:1.75rem}.header-account-help-center--item.sc-kompas-header-account-help-center{align-items:center;display:flex;flex-direction:row;padding-left:.5rem;padding-right:.5rem}.header-account-help-center--content.sc-kompas-header-account-help-center{display:flex;flex-direction:column;flex-grow:1;font-size:1rem;line-height:1.5rem;line-height:1rem;margin-left:1rem;margin-right:1rem;row-gap:.5rem}.header-account--membership-icon.sc-kompas-header-account-help-center{bottom:-3px;position:absolute;right:-4px}.header-account--notification-indicator.sc-kompas-header-account-help-center{--tw-bg-opacity:1;background-color:rgba(255,122,0,var(--tw-bg-opacity));border-radius:9999px;height:.5rem;position:absolute;right:-1px;top:0;width:.5rem}.header-account-sidebar.sc-kompas-header-account-help-center{--tw-bg-opacity:1;--tw-shadow:0 10px 15px -3px rgba(0,0,0,.1),0 4px 6px -2px rgba(0,0,0,.05);--tw-border-opacity:1;background-color:rgba(255,255,255,var(--tw-bg-opacity));border-color:rgba(238,238,238,var(--tw-border-opacity));border-width:1px;bottom:0;box-shadow:var(--tw-ring-offset-shadow,0 0 #0000),var(--tw-ring-shadow,0 0 #0000),var(--tw-shadow);display:flex;flex-direction:column;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;font-size:.875rem;height:100vh;line-height:1.25rem;overflow-y:scroll;position:fixed;right:0;top:0;width:19rem;z-index:10}.icon-xs.sc-kompas-header-account-help-center svg.sc-kompas-header-account-help-center{height:.75rem;width:.75rem}.icon-sm.sc-kompas-header-account-help-center svg.sc-kompas-header-account-help-center{height:1rem;width:1rem}.icon-md.sc-kompas-header-account-help-center svg.sc-kompas-header-account-help-center{height:1.25rem;width:1.25rem}.icon-white.sc-kompas-header-account-help-center{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.icon-white.sc-kompas-header-account-help-center svg.sc-kompas-header-account-help-center{fill:currentColor}.icon-blue-600.sc-kompas-header-account-help-center{--tw-text-opacity:1;color:rgba(3,86,168,var(--tw-text-opacity))}.icon-blue-600.sc-kompas-header-account-help-center svg.sc-kompas-header-account-help-center{fill:currentColor}.icon-grey-400.sc-kompas-header-account-help-center{--tw-text-opacity:1;color:rgba(153,153,153,var(--tw-text-opacity))}.icon-grey-400.sc-kompas-header-account-help-center svg.sc-kompas-header-account-help-center{fill:currentColor}.sc-kompas-header-account-help-center::-webkit-scrollbar{width:4px}.sc-kompas-header-account-help-center::-webkit-scrollbar-track{background:transparent}.sc-kompas-header-account-help-center::-webkit-scrollbar-thumb{background:#0356a8;border-radius:100px}.sc-kompas-header-account-help-center::-webkit-scrollbar-thumb:hover{background:#0356a8}";

class KompasHeaderAccountHelpCenter {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.clipboardClicked = false;
        // Q & A 
        this.qna = () => (hAsync("div", { class: "header-account-help-center--item" }, hAsync("div", { class: "ml-3 icon-md icon-blue-600", innerHTML: commentIcon }), hAsync("div", { class: "header-account-help-center--content" }, hAsync("p", null, "Tanya Jawab"), hAsync("a", { href: "http://kb.kompas.id/", class: "font-bold" }, "http://kb.kompas.id/"))));
        // Telephone 
        this.telephone = () => {
            // Clipboard Action
            ...
            return (hAsync("div", { class: "header-account-help-center--item" }, hAsync("div", { class: "ml-3 icon-md icon-blue-600", innerHTML: phoneAltIcon }), hAsync("div", { class: "relative header-account-help-center--content" }, this.clipboardClicked ?
                hAsync("p", { class: "absolute bg-grey-200 rounded-md h-full top-0 w-full flex items-center justify-center" }, "Berhasil menyalin!")
                :
                    "", hAsync("p", null, "Kompas Kring"), hAsync("p", { ref: el => this.kompasKring = el, class: "font-bold" }, "+6221 2567 6000")), hAsync("div", { class: "bg-grey-200 px-4 py-2 rounded cursor-pointer", onClick: () => clipboardAction() }, hAsync("div", { class: "icon-md icon-grey-400", innerHTML: copyIcon }))));
        };
        // Whatsapp
        this.whatsapp = () => (hAsync("a", { href: "https://api.whatsapp.com/send?phone=6281290050800", class: "header-account-help-center--item" }, hAsync("div", { class: "ml-3 icon-md icon-blue-600", innerHTML: whatsappIcon }), hAsync("div", { class: "header-account-help-center--content" }, hAsync("p", null, "Whatsapp"), hAsync("p", { class: "font-bold hover:underline" }, "+62812 900 50 800"))));
        // Email 
        this.email = () => (hAsync("a", { href: "mailto:hotline@kompas.id", class: "header-account-help-center--item" }, hAsync("div", { class: "ml-3 icon-md icon-blue-600", innerHTML: envelopeIcon }), hAsync("div", { class: "header-account-help-center--content" }, hAsync("p", null, "Email"), hAsync("p", { class: "font-bold hover:underline" }, "hotline@kompas.id"))));
        // Working Hour 
        this.workingHour = () => (hAsync("div", { class: "header-account-help-center--item" }, hAsync("div", { class: "ml-3 icon-md icon-blue-600", innerHTML: clockIcon }), hAsync("div", { class: "flex flex-col mx-4 leading-4 gap-y-2 text-base" }, hAsync("p", null, "Jam Kerja"), hAsync("p", { class: "font-bold" }, "06.00 - 16.00 WIB"))));
    }
    render() {
        return (hAsync("div", { class: "mt-4 p-2 mb-20 leading-4" }, hAsync("p", { class: "text-base mx-2 text-left" }, "Pusat Bantuan"), hAsync("div", { class: "flex flex-shrink-0 flex-col text-left text-sm gap-y-4 my-4" }, this.qna(), this.telephone(), this.whatsapp(), this.email(), this.workingHour())));
    }
    static get style() { return kompasHeaderAccountCss$2; }
    static get cmpMeta() {
        return {
            "$flags$": 9,
            "$tagName$": "kompas-header-account-help-center",
            "$members$": {
                "clipboardClicked": [32]
            },
            "$listeners$": undefined,
...
const kompasHeaderAccountCss$1 = ".sc-kompas-header-account-menu-h{display:block}.sc-kompas-header-account-menu-h .sc-kompas-header-account-menu{box-sizing:border-box;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji}.header-account-menu--item.sc-kompas-header-account-menu{align-items:center;border-radius:.125rem;display:flex;flex-direction:row;padding:.5rem;transition-duration:.15s;transition-property:background-color,border-color,color,fill,stroke,opacity,box-shadow,transform,filter,-webkit-backdrop-filter;transition-property:background-color,border-color,color,fill,stroke,opacity,box-shadow,transform,filter,backdrop-filter;transition-property:background-color,border-color,color,fill,stroke,opacity,box-shadow,transform,filter,backdrop-filter,-webkit-backdrop-filter;transition-timing-function:cubic-bezier(.4,0,.2,1)}.header-account-menu--item.sc-kompas-header-account-menu:hover{--tw-bg-opacity:1;background-color:rgba(238,238,238,var(--tw-bg-opacity))}.header-account-menu--title.sc-kompas-header-account-menu{flex-grow:1;font-size:1rem;font-weight:700;line-height:1.5rem;margin-left:1rem;margin-right:1rem}.header-account-menu--notification-info.sc-kompas-header-account-menu{--tw-bg-opacity:1;--tw-text-opacity:1;align-items:center;background-color:rgba(255,122,0,var(--tw-bg-opacity));border-radius:1.5rem;color:rgba(255,255,255,var(--tw-text-opacity));display:flex;font-size:.875rem;height:1.75rem;justify-content:center;line-height:1.25rem;width:1.75rem}.header-account-help-center--item.sc-kompas-header-account-menu{align-items:center;display:flex;flex-direction:row;padding-left:.5rem;padding-right:.5rem}.header-account-help-center--content.sc-kompas-header-account-menu{display:flex;flex-direction:column;flex-grow:1;font-size:1rem;line-height:1.5rem;line-height:1rem;margin-left:1rem;margin-right:1rem;row-gap:.5rem}.header-account--membership-icon.sc-kompas-header-account-menu{bottom:-3px;position:absolute;right:-4px}.header-account--notification-indicator.sc-kompas-header-account-menu{--tw-bg-opacity:1;background-color:rgba(255,122,0,var(--tw-bg-opacity));border-radius:9999px;height:.5rem;position:absolute;right:-1px;top:0;width:.5rem}.header-account-sidebar.sc-kompas-header-account-menu{--tw-bg-opacity:1;--tw-shadow:0 10px 15px -3px rgba(0,0,0,.1),0 4px 6px -2px rgba(0,0,0,.05);--tw-border-opacity:1;background-color:rgba(255,255,255,var(--tw-bg-opacity));border-color:rgba(238,238,238,var(--tw-border-opacity));border-width:1px;bottom:0;box-shadow:var(--tw-ring-offset-shadow,0 0 #0000),var(--tw-ring-shadow,0 0 #0000),var(--tw-shadow);display:flex;flex-direction:column;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;font-size:.875rem;height:100vh;line-height:1.25rem;overflow-y:scroll;position:fixed;right:0;top:0;width:19rem;z-index:10}.icon-xs.sc-kompas-header-account-menu svg.sc-kompas-header-account-menu{height:.75rem;width:.75rem}.icon-sm.sc-kompas-header-account-menu svg.sc-kompas-header-account-menu{height:1rem;width:1rem}.icon-md.sc-kompas-header-account-menu svg.sc-kompas-header-account-menu{height:1.25rem;width:1.25rem}.icon-white.sc-kompas-header-account-menu{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.icon-white.sc-kompas-header-account-menu svg.sc-kompas-header-account-menu{fill:currentColor}.icon-blue-600.sc-kompas-header-account-menu{--tw-text-opacity:1;color:rgba(3,86,168,var(--tw-text-opacity))}.icon-blue-600.sc-kompas-header-account-menu svg.sc-kompas-header-account-menu{fill:currentColor}.icon-grey-400.sc-kompas-header-account-menu{--tw-text-opacity:1;color:rgba(153,153,153,var(--tw-text-opacity))}.icon-grey-400.sc-kompas-header-account-menu svg.sc-kompas-header-account-menu{fill:currentColor}.sc-kompas-header-account-menu::-webkit-scrollbar{width:4px}.sc-kompas-header-account-menu::-webkit-scrollbar-track{background:transparent}.sc-kompas-header-account-menu::-webkit-scrollbar-thumb{background:#0356a8;border-radius:100px}.sc-kompas-header-account-menu::-webkit-scrollbar-thumb:hover{background:#0356a8}";

class KompasHeaderAccountMenu {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        /**
          * Logout Url
        ...
        this.notificationTotalInfo = () => {
            ...
            return (hAsync("div", { class: `header-account-menu--notification-info ${additionalStyling}` }, isOneDigitNotification ? this.notificationTotal : "9+"));
        };
    }
    render() {
        return (hAsync("div", null, hAsync("li", { class: "font-bold flex flex-shrink-0 gap-y-3 py-4 flex-col text-left text-sm border-b border-grey-300 p-2 leading-4" }, hAsync("a", { href: "https://gerai.kompas.id/cart", class: "header-account-menu--item" }, hAsync("div", { class: "ml-3 icon-md icon-blue-600", innerHTML: shoppingCart }), hAsync("p", { class: "header-account-menu--title" }, "Keranjang")), hAsync("a", { href: this.manageAccountUrl, class: "header-account-menu--item" }, hAsync("div", { class: "ml-3 icon-md icon-blue-600", innerHTML: userCog }), hAsync("p", { class: "header-account-menu--title" }, "Kelola Akun")), hAsync("a", { href: "https://gerai.kompas.id/my-account/orders", class: "header-account-menu--item" }, hAsync("div", { class: "ml-3 icon-md icon-blue-600", innerHTML: exchangeAlt }), hAsync("p", { class: "header-account-menu--title" }, "Transaksi")), hAsync("a", { href: "https://account.kompas.id/notification", class: "header-account-menu--item" }, hAsync("div", { class: "ml-3 icon-md icon-blue-600", innerHTML: bell }), hAsync("p", { class: "header-account-menu--title" }, "Notifikasi"), hAsync("p", { class: "flex-none" }, this.notificationTotalInfo())), hAsync("a", { href: this.logoutUrl, class: "header-account-menu--item" }, hAsync("div", { class: "ml-3 icon-md icon-blue-600", innerHTML: signOutAlt }), hAsync("p", { class: "header-account-menu--title" }, "Keluar")))));
    }
    static get style() { return kompasHeaderAccountCss$1; }
    static get cmpMeta() {
        return {
            "$flags$": 9,
            "$tagName$": "kompas-header-account-menu",
            "$members$": {
                "logoutUrl": [1, "logout-url"],
                "manageAccountUrl": [1, "manage-account-url"],
                "notificationTotal": [2, "notification-total"]
...
const kompasHeaderAccountCss = ".sc-kompas-header-account-profile-h{display:block}.sc-kompas-header-account-profile-h .sc-kompas-header-account-profile{box-sizing:border-box;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji}.header-account-menu--item.sc-kompas-header-account-profile{align-items:center;border-radius:.125rem;display:flex;flex-direction:row;padding:.5rem;transition-duration:.15s;transition-property:background-color,border-color,color,fill,stroke,opacity,box-shadow,transform,filter,-webkit-backdrop-filter;transition-property:background-color,border-color,color,fill,stroke,opacity,box-shadow,transform,filter,backdrop-filter;transition-property:background-color,border-color,color,fill,stroke,opacity,box-shadow,transform,filter,backdrop-filter,-webkit-backdrop-filter;transition-timing-function:cubic-bezier(.4,0,.2,1)}.header-account-menu--item.sc-kompas-header-account-profile:hover{--tw-bg-opacity:1;background-color:rgba(238,238,238,var(--tw-bg-opacity))}.header-account-menu--title.sc-kompas-header-account-profile{flex-grow:1;font-size:1rem;font-weight:700;line-height:1.5rem;margin-left:1rem;margin-right:1rem}.header-account-menu--notification-info.sc-kompas-header-account-profile{--tw-bg-opacity:1;--tw-text-opacity:1;align-items:center;background-color:rgba(255,122,0,var(--tw-bg-opacity));border-radius:1.5rem;color:rgba(255,255,255,var(--tw-text-opacity));display:flex;font-size:.875rem;height:1.75rem;justify-content:center;line-height:1.25rem;width:1.75rem}.header-account-help-center--item.sc-kompas-header-account-profile{align-items:center;display:flex;flex-direction:row;padding-left:.5rem;padding-right:.5rem}.header-account-help-center--content.sc-kompas-header-account-profile{display:flex;flex-direction:column;flex-grow:1;font-size:1rem;line-height:1.5rem;line-height:1rem;margin-left:1rem;margin-right:1rem;row-gap:.5rem}.header-account--membership-icon.sc-kompas-header-account-profile{bottom:-3px;position:absolute;right:-4px}.header-account--notification-indicator.sc-kompas-header-account-profile{--tw-bg-opacity:1;background-color:rgba(255,122,0,var(--tw-bg-opacity));border-radius:9999px;height:.5rem;position:absolute;right:-1px;top:0;width:.5rem}.header-account-sidebar.sc-kompas-header-account-profile{--tw-bg-opacity:1;--tw-shadow:0 10px 15px -3px rgba(0,0,0,.1),0 4px 6px -2px rgba(0,0,0,.05);--tw-border-opacity:1;background-color:rgba(255,255,255,var(--tw-bg-opacity));border-color:rgba(238,238,238,var(--tw-border-opacity));border-width:1px;bottom:0;box-shadow:var(--tw-ring-offset-shadow,0 0 #0000),var(--tw-ring-shadow,0 0 #0000),var(--tw-shadow);display:flex;flex-direction:column;font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;font-size:.875rem;height:100vh;line-height:1.25rem;overflow-y:scroll;position:fixed;right:0;top:0;width:19rem;z-index:10}.icon-xs.sc-kompas-header-account-profile svg.sc-kompas-header-account-profile{height:.75rem;width:.75rem}.icon-sm.sc-kompas-header-account-profile svg.sc-kompas-header-account-profile{height:1rem;width:1rem}.icon-md.sc-kompas-header-account-profile svg.sc-kompas-header-account-profile{height:1.25rem;width:1.25rem}.icon-white.sc-kompas-header-account-profile{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.icon-white.sc-kompas-header-account-profile svg.sc-kompas-header-account-profile{fill:currentColor}.icon-blue-600.sc-kompas-header-account-profile{--tw-text-opacity:1;color:rgba(3,86,168,var(--tw-text-opacity))}.icon-blue-600.sc-kompas-header-account-profile svg.sc-kompas-header-account-profile{fill:currentColor}.icon-grey-400.sc-kompas-header-account-profile{--tw-text-opacity:1;color:rgba(153,153,153,var(--tw-text-opacity))}.icon-grey-400.sc-kompas-header-account-profile svg.sc-kompas-header-account-profile{fill:currentColor}.sc-kompas-header-account-profile::-webkit-scrollbar{width:4px}.sc-kompas-header-account-profile::-webkit-scrollbar-track{background:transparent}.sc-kompas-header-account-profile::-webkit-scrollbar-thumb{background:#0356a8;border-radius:100px}.sc-kompas-header-account-profile::-webkit-scrollbar-thumb:hover{background:#0356a8}";

class KompasHeaderAccountProfile {
    constructor(hostRef) {
        registerInstance(this, hostRef);
    }
    render() {
         ...
         */
        const skeletonLoading = (hAsync("div", null, hAsync("div", { class: "flex flex-row mb-5 items-center gap-4 leading-none" }, hAsync("div", { class: "bg-grey-300 py-5 rounded-full h-16 w-16 animate-pulse" }), hAsync("div", { class: "flex flex-col text-left w-40 gap-y-2" }, hAsync("div", { class: "h-3 rounded-sm w-full bg-grey-300 animate-pulse" }), hAsync("div", { class: "h-3 rounded-sm w-full bg-grey-300 animate-pulse" }), hAsync("div", { class: "h-3 rounded-sm w-full bg-grey-300 animate-pulse" }))), hAsync("div", null, hAsync("div", { class: "h-6 rounded-sm w-full bg-grey-300 animate-pulse" }))));
        /**
         * Profile Content
         */
        const profileContent = () => {
            ...
            const subscribeButton = () => {
                ...
                return (hAsync("div", { class: "mt-5 w-full" }, hAsync("button", { onClick: () => handleSubscribe(), class: "w-full font-sans rounded-lg px-4 py-3 my-2 h-10 flex justify-center items-center bg-green-500 text-grey-100 font-bold text-base focus:outline-none" }, (_b = this.userData) === null || _b === void 0 ? void 0 : _b.updateMembership)));
            };
            /**
            ...
            const expiredInfo = () => {
                var _a, _b, _c;
                const isNearExpire = (_b = (_a = this.userData) === null || _a === void 0 ? void 0 : _a.expired) === null || _b === void 0 ? void 0 : _b.includes("Berakhir");
                const expiredTextColor = isNearExpire ? `text-orange-400` : `text-grey-500`;
                return (hAsync("p", { class: `capitalize font-bold text-sm pb-1 whitespace-nowrap ${expiredTextColor}` }, (_c = this.userData) === null || _c === void 0 ? void 0 : _c.expired));
            };
            /**
             * membership icon element, show if isMebership has truthy value
             */
        ...
        return (hAsync("div", { class: "border-b border-grey-300 flex flex-shrink-0 flex-col bg-blue-100 p-4" }, !this.userData ? skeletonLoading : profileContent()));
    }
    static get style() { return kompasHeaderAccountCss; }
    static get cmpMeta() {
        return {
            "$flags$": 9,
            "$tagName$": "kompas-header-account-profile",
            "$members$": {
                "userInitialName": [1, "user-initial-name"],
                "userData": [8, "user-data"]
            },
            "$listeners$": undefined,
            "$lazyBundleId$": "-",
...
const kompasPaywallCss$3 = ".transparent-linear.sc-kompas-paywall{background-image:linear-gradient(180deg,hsla(0,0%,100%,0),#fff)}.text-transition.sc-kompas-paywall{height:5rem;width:100%}.bg-white.sc-kompas-paywall,.text-transition.sc-kompas-paywall{--tw-bg-opacity:1;background-color:rgba(255,255,255,var(--tw-bg-opacity))}.text-white.sc-kompas-paywall{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.icon-xs.sc-kompas-paywall svg.sc-kompas-paywall{height:.75rem;width:.75rem}.icon-sm.sc-kompas-paywall svg.sc-kompas-paywall{height:1rem;width:1rem}.icon-md.sc-kompas-paywall svg.sc-kompas-paywall{height:1.25rem;width:1.25rem}.icon-lg.sc-kompas-paywall svg.sc-kompas-paywall{height:.75rem;width:.75rem}.icon-white.sc-kompas-paywall{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.icon-white.sc-kompas-paywall svg.sc-kompas-paywall{fill:currentColor}.icon-green-500.sc-kompas-paywall{--tw-text-opacity:1;color:rgba(80,167,24,var(--tw-text-opacity))}.icon-green-500.sc-kompas-paywall svg.sc-kompas-paywall{fill:currentColor}.icon-blue-600.sc-kompas-paywall{--tw-text-opacity:1;color:rgba(3,86,168,var(--tw-text-opacity))}.icon-blue-600.sc-kompas-paywall svg.sc-kompas-paywall{fill:currentColor}.icon-yellow-100.sc-kompas-paywall{--tw-text-opacity:1;color:rgba(255,249,204,var(--tw-text-opacity))}.icon-yellow-100.sc-kompas-paywall svg.sc-kompas-paywall{fill:currentColor}.wrapper-body.sc-kompas-paywall{align-items:center;display:flex;flex-direction:column;justify-content:center}.body.sc-kompas-paywall{height:100%;position:-webkit-sticky;position:sticky;top:0;width:100%}@media (min-width:768px){.icon-lg.sc-kompas-paywall svg.sc-kompas-paywall{height:1.25rem;width:1.25rem}}";

class KompasPaywall {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.paywallData = undefined; // add interface type
        this.isExtensionsOpened = false;
        this.isLogin = false;
        this.type = "reguler";
        this.isWithHeader = false;
        this.textHeader = "";
        this.transitionBox = () => (hAsync("div", { class: "transparent-linear h-20 -mt-24 z-0 w-full " }));
        this.renderEpaperPaywallSection = () => (hAsync("kompas-paywall-body", { isLogin: this.isLogin, type: this.type, paywallData: this.paywallData }));
        this.renderRegularPaywallSection = () => {
            const defaultHeaderText = this.paywallData.informations.meterred.maxQuotaMessage;
            if (this.isWithHeader) {
                return (hAsync("div", null, this.transitionBox(), hAsync("div", { class: "flex flex-col bg-white items-center justify-center mx-4 md:mx-0" }, hAsync("div", { class: "flex flex-col w-full max-w-screen-md my-5" }, hAsync("kompas-paywall-information-header", { text: this.textHeader || defaultHeaderText }), hAsync("kompas-paywall-body", { isLogin: this.isLogin, type: this.type, paywallData: this.paywallData })))));
            }
            else {
                return (hAsync("div", null, this.transitionBox(), hAsync("div", { class: "flex flex-col bg-white items-center justify-center mx-4 md:mx-0" }, hAsync("div", { class: "flex flex-col w-full max-w-screen-md my-5" }, hAsync("kompas-paywall-banner-registration", { bannerData: this.paywallData.informations.register }), hAsync("kompas-paywall-body", { isLogin: this.isLogin, type: this.type, paywallData: this.paywallData })))));
            }
        };
    ...
    render() {
        return (hAsync("div", { class: "relative w-full" }, this.selectorTypePaywall(this.type)));
    }
    static get style() { return kompasPaywallCss$3; }
    static get cmpMeta() {
        return {
            "$flags$": 9,
            "$tagName$": "kompas-paywall",
            "$members$": {
                "isLogin": [4, "is-login"],
                "type": [1],
                "isWithHeader": [4, "is-with-header"],
                "textHeader": [1, "text-header"],
                "paywallData": [32],
                "isExtensionsOpened": [32]
            },
            "$listeners$": undefined,
            "$lazyBundleId$": "-",
            "$attrsToReflect$": []
...
const kompasPaywallCss$2 = ".transparent-linear.sc-kompas-paywall-banner-registration{background-image:linear-gradient(180deg,hsla(0,0%,100%,0),#fff)}.text-transition.sc-kompas-paywall-banner-registration{height:5rem;width:100%}.bg-white.sc-kompas-paywall-banner-registration,.text-transition.sc-kompas-paywall-banner-registration{--tw-bg-opacity:1;background-color:rgba(255,255,255,var(--tw-bg-opacity))}.text-white.sc-kompas-paywall-banner-registration{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.icon-xs.sc-kompas-paywall-banner-registration svg.sc-kompas-paywall-banner-registration{height:.75rem;width:.75rem}.icon-sm.sc-kompas-paywall-banner-registration svg.sc-kompas-paywall-banner-registration{height:1rem;width:1rem}.icon-md.sc-kompas-paywall-banner-registration svg.sc-kompas-paywall-banner-registration{height:1.25rem;width:1.25rem}.icon-lg.sc-kompas-paywall-banner-registration svg.sc-kompas-paywall-banner-registration{height:.75rem;width:.75rem}.icon-white.sc-kompas-paywall-banner-registration{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.icon-white.sc-kompas-paywall-banner-registration svg.sc-kompas-paywall-banner-registration{fill:currentColor}.icon-green-500.sc-kompas-paywall-banner-registration{--tw-text-opacity:1;color:rgba(80,167,24,var(--tw-text-opacity))}.icon-green-500.sc-kompas-paywall-banner-registration svg.sc-kompas-paywall-banner-registration{fill:currentColor}.icon-blue-600.sc-kompas-paywall-banner-registration{--tw-text-opacity:1;color:rgba(3,86,168,var(--tw-text-opacity))}.icon-blue-600.sc-kompas-paywall-banner-registration svg.sc-kompas-paywall-banner-registration{fill:currentColor}.icon-yellow-100.sc-kompas-paywall-banner-registration{--tw-text-opacity:1;color:rgba(255,249,204,var(--tw-text-opacity))}.icon-yellow-100.sc-kompas-paywall-banner-registration svg.sc-kompas-paywall-banner-registration{fill:currentColor}.wrapper-body.sc-kompas-paywall-banner-registration{align-items:center;display:flex;flex-direction:column;justify-content:center}.body.sc-kompas-paywall-banner-registration{height:100%;position:-webkit-sticky;position:sticky;top:0;width:100%}@media (min-width:768px){.icon-lg.sc-kompas-paywall-banner-registration svg.sc-kompas-paywall-banner-registration{height:1.25rem;width:1.25rem}}";

class KompasPaywallBannerRegistration {
    constructor(hostRef) {
        registerInstance(this, hostRef);
    ...
    render() {
        return (hAsync("div", { class: "flex flex-col items-center my-5" }, hAsync("div", { class: "flex flex-col md:flex-row justify-between items-center w-full" }, hAsync("div", { class: "flex flex-col md:flex-row items-center w-full" }, hAsync("img", { class: "object-cover w-20 h-20", src: this.bannerData.img, alt: "information-register-img" }), hAsync("div", { class: "flex flex-col justify-start md:ml-6 my-4" }, hAsync("h5", { class: "text-center md:text-left text-base md:text-xl font-serif font-bold" }, this.bannerData.title), hAsync("h6", { class: "text-center md:text-left" }, this.bannerData.subtitle))), hAsync("button", { onClick: () => this.redirectToRegister(), class: "w-40 md:w-52 h-auto bg-brand-1 rounded" }, hAsync("h6", { class: "text-base text-white font-bold py-2 px-4" }, this.bannerData.label))), hAsync("div", { class: "border-b-2 border-grey-200 w-32 md:w-40 my-6" }), hAsync("div", null, hAsync("h6", null, "Sudah punya akun? ", hAsync("button", { onClick: () => this.redirectToRegister(), class: "text-blue-600 font-bold underline" }, "Silakan Masuk")))));
    }
    static get style() { return kompasPaywallCss$2; }
    static get cmpMeta() {
        return {
            "$flags$": 9,
            "$tagName$": "kompas-paywall-banner-registration",
            "$members$": {
                "bannerData": [16]
            },
            "$listeners$": undefined,
...
var star = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z"/></svg>`;

var arrowLeft = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Free 5.15.3 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) --><path d="M257.5 445.1l-22.2 22.2c-9.4 9.4-24.6 9.4-33.9 0L7 273c-9.4-9.4-9.4-24.6 0-33.9L201.4 44.7c9.4-9.4 24.6-9.4 33.9 0l22.2 22.2c9.5 9.5 9.3 25-.4 34.3L136.6 216H424c13.3 0 24 10.7 24 24v32c0 13.3-10.7 24-24 24H136.6l120.5 114.8c9.8 9.3 10 24.8.4 34.3z"/></svg>`;

const kompasPaywallCss$1 = ".transparent-linear.sc-kompas-paywall-body{background-image:linear-gradient(180deg,hsla(0,0%,100%,0),#fff)}.text-transition.sc-kompas-paywall-body{height:5rem;width:100%}.bg-white.sc-kompas-paywall-body,.text-transition.sc-kompas-paywall-body{--tw-bg-opacity:1;background-color:rgba(255,255,255,var(--tw-bg-opacity))}.text-white.sc-kompas-paywall-body{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.icon-xs.sc-kompas-paywall-body svg.sc-kompas-paywall-body{height:.75rem;width:.75rem}.icon-sm.sc-kompas-paywall-body svg.sc-kompas-paywall-body{height:1rem;width:1rem}.icon-md.sc-kompas-paywall-body svg.sc-kompas-paywall-body{height:1.25rem;width:1.25rem}.icon-lg.sc-kompas-paywall-body svg.sc-kompas-paywall-body{height:.75rem;width:.75rem}.icon-white.sc-kompas-paywall-body{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.icon-white.sc-kompas-paywall-body svg.sc-kompas-paywall-body{fill:currentColor}.icon-green-500.sc-kompas-paywall-body{--tw-text-opacity:1;color:rgba(80,167,24,var(--tw-text-opacity))}.icon-green-500.sc-kompas-paywall-body svg.sc-kompas-paywall-body{fill:currentColor}.icon-blue-600.sc-kompas-paywall-body{--tw-text-opacity:1;color:rgba(3,86,168,var(--tw-text-opacity))}.icon-blue-600.sc-kompas-paywall-body svg.sc-kompas-paywall-body{fill:currentColor}.icon-yellow-100.sc-kompas-paywall-body{--tw-text-opacity:1;color:rgba(255,249,204,var(--tw-text-opacity))}.icon-yellow-100.sc-kompas-paywall-body svg.sc-kompas-paywall-body{fill:currentColor}.wrapper-body.sc-kompas-paywall-body{align-items:center;display:flex;flex-direction:column;justify-content:center}.body.sc-kompas-paywall-body{height:100%;position:-webkit-sticky;position:sticky;top:0;width:100%}@media (min-width:768px){.icon-lg.sc-kompas-paywall-body svg.sc-kompas-paywall-body{height:1.25rem;width:1.25rem}}";

class KompasPaywallBody {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.slug = "";
        this.isLogin = false;
        ...
        this.isExtensionsOpened = false;
        this.primaryPackages = (product) => (hAsync("div", { class: "flex flex-wrap justify-between items-center bg-white rounded md:mx-0 w-full max-w-xs md:max-w-sm md:w-3/5 mt-2.5 md:mt-4 border border-yellow-400 relative" }, hAsync("div", { class: "flex flex-col py-3 ml-6 md:ml-8" }, hAsync("div", { class: "flex flex-none items-center" }, hAsync("h5", { class: "text-base md:text-lg font-bold text-orange-400" }, this.getRupiahFormat(product.price)), hAsync("h6", { class: "text-xs md:text-base font-bold pl-1" }, "/ ", product.periode)), hAsync("div", { class: "flex items-center" }, hAsync("p", { class: "text-xs md:text-sm text-grey-400 line-through" }, this.getRupiahFormat(product.discountPrice)), hAsync("div", { class: "rounded bg-red-100 ml-1 md:p-0.5" }, hAsync("p", { class: "font-bold text-xs text-red-400" }, "-", product.percentage, "%")))), hAsync("button", { onClick: () => this.redirectToCheckout(product.url), class: "h-auto bg-green-500 rounded mr-3" }, hAsync("h6", { class: "text-xs md:text-base text-white font-bold py-2 px-4" }, "Beli Paket")), hAsync("div", { class: "absolute top-0 left-0" }, hAsync("div", { class: "w-9 md:w-14 md:h-10 overflow-hidden  inline-block absolute" }, hAsync("div", { class: "h-36 bg-yellow-400 rotate-45 md:rotate-55 transform origin-top-right relative" })), hAsync("div", { class: "icon-yellow-100 icon-sm md:icon-base mt-0.5 ml-1 absolute", innerHTML: star }))));
        this.secondaryPackages = (product) => (hAsync("div", { class: "flex  flex-wrap justify-between bg-white py-3 px-4 rounded md:mx-0 w-full max-w-xs md:max-w-sm md:w-3/5 mt-3 md:mt-4" }, hAsync("div", { class: "flex items-center" }, hAsync("h5", { class: "text-base md:text-lg font-bold text-orange-400" }, this.getRupiahFormat(product.price)), hAsync("h6", { class: " text-xs md:text-base font-bold pl-1" }, "/ ", product.periode)), hAsync("button", { onClick: () => this.redirectToCheckout(product.url), class: "h-auto bg-green-500 rounded" }, hAsync("h6", { class: "text-xs md:text-base text-white font-bold py-2 px-4" }, "Beli Paket"))));
        this.helpDesk = () => (hAsync("div", { class: "py-2.5 text-white self-center text-xs md:text-sm" }, "Mengalami masalah? Hubungi ", hAsync("button", { onClick: () => this.redirectToHelpdesk(), class: "font-bold underline" }, "Layanan Pelanggan.")));
        this.authRegister = () => (hAsync("div", { class: "flex flex-row text-white py-2.5 space-x-8 self-center" }, hAsync("div", { class: "flex flex-col" }, hAsync("b", { class: "hidden md:block text-sm text-white" }, "Sudah berlangganan Kompas Premium?"), hAsync("b", { class: "md:hidden text-xs text-white" }, "Sudah berlangganan?"), hAsync("p", { class: "hidden md:block text-sm text-white" }, "Masuk ke akun anda untuk lanjut baca."), hAsync("p", { class: "text-xs md:hidden text-white" }, "Masuk untuk lanjut baca.")), hAsync("button", { onClick: () => this.redirectToRegister(), class: "h-auto bg-grey-100 rounded mr-3" }, hAsync("p", { class: "text-xs md:text-base text-blue-600 font-bold py-2 px-4" }, "Masuk / Daftar"))));
        this.userAction = (isLogin, type) => (hAsync("div", { class: "flex h-20 bg-blue-600 w-full justify-evenly rounded-b mt-6 md:mt-8 relative" }, isLogin || (type !== "epaper") ? this.helpDesk() : this.authRegister()));
        this.topNavigator = () => (hAsync("div", { class: "flex lg:hidden items-center w-full pb-4 " }, hAsync("div", { class: " icon-lg icon-white mr-3.5 md:mr-5 ", innerHTML: arrowLeft }), hAsync("button", { onClick: () => this.redirectToPrevUrl(), class: "text-xs md:text-lg text-white" }, "Kembali")));
        this.headerSection = (type) => (hAsync("div", { class: "flex w-full items-center" }, type === "epaper" ? hAsync("button", { onClick: () => this.redirectToPrevUrl(), class: "hidden lg:flex icon-lg icon-blue-600 pl-4 ", innerHTML: arrowLeft }) : "", hAsync("h4", { class: "text-base md:text-xl text-center font-bold font-serif tracking-wide md:tracking-normal w-full" }, "Langganan untuk Lanjut Membaca")));
        this.descriptionSection = (data) => (hAsync("div", { class: " flex flex-col items-center" }, hAsync("div", { class: "flex flex-col space-y-2 mt-2.5 md:mt-3" }, data.map((item) => (hAsync("div", { class: "flex items-center" }, hAsync("div", { class: "icon-xs icon-green-500", innerHTML: check }), hAsync("h6", { class: "text-xs md:text-base ml-0.5 md:ml-1" }, item)))))));
        this.packagesSection = (data) => (hAsync("div", { class: "flex flex-col w-full items-center mt-8 lg:mt-2 px-2 " }, hAsync("h6", { class: "text-sm md:text-base font-bold" }, " ", data.title, " "), data.memberships.map((item) => (item.isHighlight ? this.primaryPackages(item) : this.secondaryPackages(item)))));
        this.paymentDesktopSection = (data) => (hAsync("div", { class: "hidden md:flex w-full md:max-w-xs lg:max-w-md items-center justify-evenly flex-wrap" }, data.map((item) => (hAsync("img", { class: "object-cover w-16 h-9", src: item.link, alt: `${item.name}-logo-payment` })))));
        this.paymentMobileSection = (data) => (hAsync("div", { class: "grid md:hidden items-center grid-flow-col grid-cols-auto grid-rows-1 gap-4 mt-4 mx-4" }, data.map((item) => (hAsync("img", { class: "", src: item.link, alt: `${item.name}-logo-payment` }))), hAsync("button", { onClick: () => this.paymentExtensionHandler(), class: "text-xs md:text-sm text-blue-600 font-bold" }, "+9 lainnya ")));
        this.paymentMobileExtension = (data) => (hAsync("div", { class: "w-full bottom-0 max-w-xs mb-1 ml-8 md:hidden absolute px-4" }, hAsync("div", { class: "bg-white border-white w-full rounded p-3 max-w-xs" }, hAsync("svg", { class: "right-0 text-white h-4 mr-10 -mt-7 border-white z-0 transform rotate-180 absolute", x: "0px", y: "0px", viewBox: "0 0 255 255" }, hAsync("polygon", { class: "fill-current", points: "0,0 127.5,127.5 255,0" })), hAsync("div", { class: "grid place-items-center items-center grid-flow-row grid-cols-5 grid-rows-2  gap-y-4" }, data.map((item) => (hAsync("img", { class: "object-cover", src: item.link, alt: `${item.name}-logo-payment` })))))));
        this.informationPackages = () => (hAsync("div", { class: "mt-4 flex justify-center" }, hAsync("button", { onClick: () => this.redirectToSubscriber(), class: "text-sm md:text-base font-bold underline text-blue-600" }, "Lihat Paket Lainnya")));
        this.separatorLine = () => (hAsync("div", { class: "hidden border-b-2 border-blue-200 w-1/4 my-4 md:flex justify-center" }));
        this.getRupiahFormat = (value) => {
        ...
        this.paymentExtensionHandler = () => {
            this.isExtensionsOpened = !this.isExtensionsOpened;
        };
    }
    render() {
        return (hAsync("div", { class: this.type === "epaper" ? "bg-transparent wrapper-body" : "bg-white wrapper-body" }, hAsync("div", { class: "flex flex-col  justify-center items-center w-full max-w-screen-sm px-4 md:px-0 my-5 relative" }, this.type === "epaper" ? this.topNavigator() : "", hAsync("div", { class: "flex w-full flex-col items-center justify-center bg-blue-100 rounded pt-6 md:pt-8 relative" }, this.headerSection(this.type), this.descriptionSection(this.paywallData.informations.description), this.packagesSection(this.paywallData.packages), this.informationPackages(), this.separatorLine(), this.paymentDesktopSection(this.paywallData.payment.desktop), this.paymentMobileSection(this.paywallData.payment.mobile), this.userAction(this.isLogin, this.type)), this.isExtensionsOpened ? (this.paymentMobileExtension(this.paywallData.payment.ekstension)) : "")));
    }
    static get style() { return kompasPaywallCss$1; }
    static get cmpMeta() {
        return {
            "$flags$": 9,
            "$tagName$": "kompas-paywall-body",
            "$members$": {
                "slug": [1],
                "isLogin": [4, "is-login"],
                "type": [1],
...
const kompasPaywallCss = ".transparent-linear.sc-kompas-paywall-information-header{background-image:linear-gradient(180deg,hsla(0,0%,100%,0),#fff)}.text-transition.sc-kompas-paywall-information-header{height:5rem;width:100%}.bg-white.sc-kompas-paywall-information-header,.text-transition.sc-kompas-paywall-information-header{--tw-bg-opacity:1;background-color:rgba(255,255,255,var(--tw-bg-opacity))}.text-white.sc-kompas-paywall-information-header{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.icon-xs.sc-kompas-paywall-information-header svg.sc-kompas-paywall-information-header{height:.75rem;width:.75rem}.icon-sm.sc-kompas-paywall-information-header svg.sc-kompas-paywall-information-header{height:1rem;width:1rem}.icon-md.sc-kompas-paywall-information-header svg.sc-kompas-paywall-information-header{height:1.25rem;width:1.25rem}.icon-lg.sc-kompas-paywall-information-header svg.sc-kompas-paywall-information-header{height:.75rem;width:.75rem}.icon-white.sc-kompas-paywall-information-header{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.icon-white.sc-kompas-paywall-information-header svg.sc-kompas-paywall-information-header{fill:currentColor}.icon-green-500.sc-kompas-paywall-information-header{--tw-text-opacity:1;color:rgba(80,167,24,var(--tw-text-opacity))}.icon-green-500.sc-kompas-paywall-information-header svg.sc-kompas-paywall-information-header{fill:currentColor}.icon-blue-600.sc-kompas-paywall-information-header{--tw-text-opacity:1;color:rgba(3,86,168,var(--tw-text-opacity))}.icon-blue-600.sc-kompas-paywall-information-header svg.sc-kompas-paywall-information-header{fill:currentColor}.icon-yellow-100.sc-kompas-paywall-information-header{--tw-text-opacity:1;color:rgba(255,249,204,var(--tw-text-opacity))}.icon-yellow-100.sc-kompas-paywall-information-header svg.sc-kompas-paywall-information-header{fill:currentColor}.wrapper-body.sc-kompas-paywall-information-header{align-items:center;display:flex;flex-direction:column;justify-content:center}.body.sc-kompas-paywall-information-header{height:100%;position:-webkit-sticky;position:sticky;top:0;width:100%}@media (min-width:768px){.icon-lg.sc-kompas-paywall-information-header svg.sc-kompas-paywall-information-header{height:1.25rem;width:1.25rem}}";

class KompasPaywallInformationHeader {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.text = "";
    }
    render() {
        return (hAsync("div", { class: "my-4 md:my-8" }, hAsync("h5", { class: "text-base text-center md:text-xl font-bold font-serif" }, this.text)));
    }
    static get style() { return kompasPaywallCss; }
    static get cmpMeta() {
        return {
            "$flags$": 9,
            "$tagName$": "kompas-paywall-information-header",
            "$members$": {
                "text": [1]
            },
            "$listeners$": undefined,
...
registerComponents([
  ...
  KompasFooter,
  KompasFooterDefault,
  KompasFooterProducts,
  KompasFooterSupports,
  KompasHeaderAccount,
