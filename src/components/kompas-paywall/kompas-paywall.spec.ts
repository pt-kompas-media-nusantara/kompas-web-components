        ...
        <div class="relative w-full">
          <div>
            ...
            <div class="bg-white flex flex-col items-center justify-center md:mx-0 mx-4">
              <div class="flex flex-col max-w-screen-md my-5 w-full">
                <kompas-paywall-banner-registration></kompas-paywall-banner-registration>
                <kompas-paywall-body countdownarticle="0" islogin="" paywall_location="" paywall_position="0" paywall_subscription_id="0" paywall_subscription_package="" paywall_subscription_price="0" subscriptionstatus="" tracker_content_categories="" tracker_content_id="" tracker_content_title="" tracker_epaper_edition="" tracker_metered_wall_balance="0" tracker_metered_wall_type="" tracker_page_domain="" tracker_page_type="" tracker_subscription_status="" tracker_user_type="" type="reguler" userguid=""></kompas-paywall-body>
              </div>
            </div>
          </div>
        </div>
