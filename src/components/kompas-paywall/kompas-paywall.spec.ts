          ...
          <div>
            ...
            <div class="bg-white flex flex-col items-center justify-center md:mx-0 mx-4">
              <div class="flex flex-col max-w-screen-md my-5 w-full">
                ...
                <kompas-paywall-body countdownarticle="0" paywall_location="" paywall_position="0" paywall_subscription_id="0" paywall_subscription_package="0" paywall_subscription_price="0" subscriptionstatus="" tracker_content_category="" tracker_content_id="" tracker_content_title="" tracker_metered_wall_balance="0" tracker_metered_wall_type="" tracker_page_domain="" tracker_page_type="" tracker_subscription_status="" tracker_user_type="" type="reguler" userguid=""></kompas-paywall-body>
              </div>
            </div>
          </div>
        </mock:shadow-root>
  ...
  it('should render kompas paywall epaper when user islogin', async () => {
    ...
    expect(root).toEqualHtml(`
      <kompas-paywall type='epaper' is-login='true'>
        <mock:shadow-root>
          <div class="relative w-full">
          <kompas-paywall-body countdownarticle="0" islogin="" paywall_location="" paywall_position="0" paywall_subscription_id="0" paywall_subscription_package="0" paywall_subscription_price="0" subscriptionstatus="" tracker_content_category="" tracker_content_id="" tracker_content_title="" tracker_content_type="" tracker_metered_wall_balance="0" tracker_metered_wall_type="" tracker_page_domain="" tracker_page_type="" tracker_subscription_status="" tracker_user_type="" type="epaper" userguid=""></kompas-paywall-body>
          </div>
        </mock:shadow-root>
      </kompas-paywall>
     `)
