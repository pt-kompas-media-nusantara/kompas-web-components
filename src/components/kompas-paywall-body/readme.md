...
| `paywall_subscription_package_annual`  | `paywall_subscription_package_annual`  |             | `string`                | `''`        |
| `paywall_subscription_package_monthly` | `paywall_subscription_package_monthly` |             | `string`                | `''`        |
